...
## ✨ Bloqueo de XNF tokens

- Xenify introduce un sistema de recompensas dinámico que ofrece importantes ventajas a los holders de XNF. Al bloquear los tokens XNF, los usuarios pueden optar a recibir cada día un impresionante 40% de las comisiones por quema y swaps generadas en las cadenas soportadas.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ✨ Reciclaje Recompensas nativas

  - El reciclaje de las recompensas de la cadena nativa ofrece una amplia gama de ventajas y es una decisión estratégica a tener en cuenta. Al optar por reciclar tus recompensas, no sólo te ahorrarás el fee de reclamacion del 25%, sino que también desbloquea la posibilidad de participar en el ciclo de quema sin aportar tokens nativos adicionales para cubrir la tasa de quema obligatoria. A diferencia del proceso de quema normal, nuestro protocolo deduce de forma exclusiva la tasa de quema de sus recompensas recicladas, lo que permite una participación sin tasas.

  - El reciclaje también proporciona una puerta de acceso a distribuciones diarias exclusivas. Obtendrás acceso a recompensas adicionales, incluidos tokens veXNF extraídos de la recompra diaria del protocolo. Además, recibirá tokens nativos generados a partir del fee de reclamación del 25% cuando opte por reciclar durante la primera hora de un ciclo. Es un conjunto de recompensas que no para de dar.

  - Pero aquí viene lo mejor, cuando reciclas, tus recompensas contribuyen en gran medida a fortalecer nuestro ecosistema. Tu contribución no sólo aumentará las recompensas para los holders de veXNF, sino que también estimula la proliferación de liquidez XNF del protocolo y apoya los esfuerzos operativos de nuestro equipo. Es un movimiento estratégico que fortalece Xenify desde dentro hacia fuera.
...
<p align="center" dir="auto">
  <picture>
    <source media="(prefers-color-scheme: light)" srcset="https://github.com/xenify-io/litepaper/assets/66044824/70b29f23-9c1c-41e3-963d-e39b68a1d557" class="source-light">
    <source media="(prefers-color-scheme: dark)" srcset="https://github.com/xenify-io/litepaper/assets/66044824/846bd190-694f-423f-8cd7-516511c9faaf" class="fuente-oscuro">
...
## ◽️ ¿Los contratos son de código abierto?
- Nuestros contratos son de acceso abierto para su visualización y están sujetos a la licencia BUSL-1.1. Sin embargo, es fundamental tener en cuenta que cualquier forma de redistribución, modificación o reutilización de nuestros contratos, ya sea en su totalidad o en parte, está estrictamente prohibida a menos que se obtenga la aprobación explícita por escrito de todos los cofundadores. Las solicitudes de aprobación deben dirigirse a las direcciones de correo electrónico oficiales de los cofundadores, asegurando que las respuestas se reciban directamente de estas direcciones. Estas medidas se implementan con el objetivo primordial de proteger los intereses de nuestros titulares.
