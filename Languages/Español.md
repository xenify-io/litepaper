...
- [vXEN - Quemaduras XEN entre cadenas](https://github.com/xenify-io/litepaper/blob/main/Languages/Espa%C3%B1ol.md#%EF%B8%8F-vxen---quemaduras-xen-entre-cadenas)
- [vXNF - Quemaduras XNF entre cadenas](https://github.com/xenify-io/litepaper/blob/main/Languages/Espa%C3%B1ol.md#%EF%B8%8F-vxnf---quemaduras-xnf-entre-cadenas)
...
- Xenify iniciará un evento de lanzamiento aéreo en cada cadena en la que opera. A lo largo de esta fase se distribuirán 1,500,000 XNF a los participantes.

- Tanto para BNB Chain como para Arbitrum, nuestros eventos de lanzamiento aéreo de 60 días contarán con la asignación de 25,000 tokens XNF en función de la contribución de cada participante a través de tarifas de intercambio. Esto se extiende a los intercambios realizados en todas las cadenas compatibles con EVM admitidas, lo que garantiza una inclusión generalizada. Para ser elegible para el lanzamiento aéreo, las transacciones deben originarse o completarse en una cadena EVM, siempre que los participantes hayan optado por pagar la tarifa de intercambio del 0.5%.

- Una vez que concluye un evento de lanzamiento aéreo, los destinatarios tendrán la posibilidad de reclamar sus tokens XNF al momento de su implementación. Estos tokens lanzados desde el aire se desbloquearán gradualmente durante 730 días. Por ejemplo, si reclama 7300 tokens XNF bloqueados del lanzamiento aéreo, puede anticipar un desbloqueo de aproximadamente 10 tokens XNF diariamente en su billetera.
...
Este enfoque de beneficio mutuo garantiza la proliferación perpetua de liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF, independientemente de las condiciones del mercado, al tiempo que mejora las recompensas para los participantes dedicados dentro del ecosistema Xenify. A través de estos incentivos alineados que capturan valor para todos los participantes, Xenify cultiva un ecosistema próspero a largo plazo. Además, en el corazón del espíritu de Xenify se encuentra un firme compromiso con la equidad y la transparencia, plasmado en nuestro modelo ejemplar de distribución de tokens. Con un suministro total máximo de sólo 22.600.000 tokens XNF, no habrá asignación para el equipo, los fundadores o los inversores. De hecho, la única forma de adquirir tokens XNF es mediante la participación activa en el ecosistema. Este enfoque garantiza una distribución verdaderamente equitativa de los tokens XNF, recompensando a los usuarios por sus contribuciones y fomentando un protocolo impulsado por la comunidad.
...
- ¡Y las recompensas siguen llegando! Tener veXNF le da derecho a recompensas diarias adicionales, como ETH, BNB y MATIC, según las tarifas de quema, tarifas de intercambio y tarifas nativas generadas durante cada ciclo. Xenify no sólo simplifica el proceso de intercambio; lo está transformando. No solo le ofrecemos la máxima eficiencia y tasas líderes en el mercado, sino también una experiencia de swap verdaderamente gratificante.
...
![Line Divider - Filled](https://user-images.githubusercontent.com/60996729/233879462-b465c484-4c2f-4cd2-a126-19529e333d64.png)
# ◽️ vXEN - Quemaduras XEN entre cadenas
![Line Divider - Filled](https://user-images.githubusercontent.com/60996729/233879462-b465c484-4c2f-4cd2-a126-19529e333d64.png)
...
![Line Divider - Filled](https://user-images.githubusercontent.com/60996729/233879462-b465c484-4c2f-4cd2-a126-19529e333d64.png)
# ◽️ vXNF - Quemaduras XNF entre cadenas
![Line Divider - Filled](https://user-images.githubusercontent.com/60996729/233879462-b465c484-4c2f-4cd2-a126-19529e333d64.png)

<br>

Presentamos vXNF, una solución innovadora desarrollada por Xenify que permite a los titulares de XNF de Arbitrum y a los titulares de bXNF de BNB Chain participar y ganar recompensas ETH en Ethereum. A diferencia de Arbitrum y BNB Chain, donde los usuarios queman lotes de vXEN o YSL, las Ethereum Burn Auctions requerirán que los participantes quemen lotes de vXNF.

Para obtener vXNF, simplemente necesita XNF en Arbitrum o bXNF en BNB Chain. Cuando quema su XNF o bXNF para adquirir vXNF, el contrato de Xenify quema automáticamente sus tokens y acuña una cantidad equivalente de vXNF en su dirección de Ethereum. Es así de simple. Una vez que tenga sus tokens vXNF, podrá participar en las quemas de Ethereum para eXNF, cuya subasta puede bloquear para ganar recompensas ETH. De esta manera, podrá disfrutar de los beneficios del ecosistema multicadena de Xenify y ganar recompensas en todas las cadenas.

Con vXNF, puede unirse sin problemas a las subastas diarias de Ethereum para eXNF, que pueden bloquearse para ganar recompensas ETH. Al permitir una participación sin fricciones para nuestra diversa base de usuarios de XNF, vXNF demuestra nuestro compromiso con la interoperabilidad y la accesibilidad entre cadenas. Ya sea que tenga XNF, bXNF o pronto eXNF, Xenify le permite maximizar las recompensas en múltiples cadenas en un ecosistema unificado.
...
| Núm | Identificadores   | Cadenas               | YSL por lote            | Suministro máximo      |
|:----|:------------------|:----------------------|:------------------------|------------------------|
...
- **21,000,000 XNF asignados para las subastas diarias:** Los usuarios que participen en diversas actividades que impulsen el desarrollo continuo del protocolo tendrán la oportunidad de ganar una parte de los tokens XNF dedicados a las subastas diarias.
  ...
  - Se distribuyen 10.500.000 XNF (50%) a los participantes de la subasta de quema en función de la cantidad de lotes quemados durante cada ciclo.
    
  - Se distribuirán 9,450,000 XNF (45%) entre los usuarios que aporten tokens nativos para participar en la subasta diaria. Estos tokens XNF se distribuirán entre los participantes en forma de veXNF, con un periodo de bloqueo asociado de 1 año.

  - 1,050,000 XNF (5%) se distribuyen a los usuarios que participan en swaps en cadenas EVM soportadas. Estos tokens XNF se distribuirán entre los participantes de los swaps en forma de veXNF, con un periodo de bloqueo asociado de 1 año.

- **100,000 XNF asignados para establecer el fondo de liquidez de Uniswap V3:** Para potenciar un ecosistema sólido, se reservarán 100,000 XNF para iniciar la liquidez propiedad del protocolo en el momento del lanzamiento. Esta iniciativa permitirá a nuestra comunidad intercambiar XNF sin problemas desde el principio. Para facilitar esto, la mayoría de las tarifas generadas a partir de la participación del primer día (incluidas las tarifas de swap, las tarifas nativas y las tarifas de quema) se utilizarán para establecer un fondo de liquidez Uniswap V3 al final del ciclo.

- **1,500,000 XNF asignados como lanzamiento aéreo exclusivo:** Para fomentar la participación, cada cadena tendrá un lanzamiento aéreo exclusivo de 1,500,000 XNF antes del despliegue. Los participantes podrán reclamar su lanzamiento aéreo el primer día del lanzamiento y se distribuirán como tokens bloqueados, que se desbloquearán gradualmente a lo largo de 730 días.
...
- BNB Chain está lista para implementarse después de Arbitrum.
...
- Base se determinará después del despliegue de Ethereum.

### 6️⃣ Optimism (opXNF)

- Optimism se determinará tras el despliegue de la Base.

### 7️⃣ Avalanche (aXNF)

- Avalanche se determinará después del despliegue de Optimism.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⚙️ Despliegue acelerado

Nuestro cronograma de implementación tiene como objetivo concentrar la liquidez y la energía/actividad económica en una cadena antes de expandirse. Este enfoque centrado tiene como objetivo generar un crecimiento sostenible frente a lanzamientos agresivos de múltiples cadenas que se adaptan mejor a las condiciones alcistas del mercado. Sin embargo, es esencial enfatizar nuestra flexibilidad para acelerar nuestro cronograma de implementación en Polygon, Ethereum, Base, Optimism y Avalanche. Dependiendo de las condiciones del mercado, mantenemos la capacidad de acelerar nuestros cronogramas de implementación a tan solo 1 mes o incluso solo 1 semana. Esta adaptabilidad nos permite responder estratégicamente a las condiciones del mercado y al mismo tiempo garantizar una expansión controlada y bien considerada que maximice los beneficios para toda nuestra comunidad.
...
Nuestro protocolo está diseñado para garantizar el crecimiento perpetuo de la liquidez propiedad del protocolo ETH con cada ciclo posterior. A partir del segundo ciclo, una gran parte del ETH obtenido diariamente (a través de tarifas de quema, tarifas nativas, tarifas de intercambio y actividades de reciclaje) se utilizará para respaldar el crecimiento de la liquidez de ETH. Dentro de este marco, ETH se utiliza para comprar y quemar XNF en el mercado; Simultáneamente, la cantidad equivalente de WETH, que se utilizó para la recompra y quema de XNF, se inyecta en el grupo propiedad del protocolo. Esta acción da como resultado un aumento significativo de WETH dentro del fondo de liquidez WETH-XNF, lo que garantiza una cobertura integral en todo el rango propiedad del protocolo.
...
La distribución de tokens XNF sigue ciclos de un día y comienza con un fondo de recompensa de 20.000 tokens XNF. Esta asignación diaria se divide de tres maneras: el 50% se distribuye a los usuarios que graban vXEN o YSL, el 45% se distribuye a los contribuyentes de tokens nativos y el 5% restante se distribuye entre los contribuyentes de la tarifa de intercambio de la plataforma. Esta asignación diaria también se extenderá a todas las demás cadenas de implementación futuras. Mediante la implementación de un modelo de reducción a la mitad, la cantidad diaria de acuñación se reduce gradualmente, culminando con la distribución completa del total de 22,6 millones de tokens XNF en el mes 2461.
...
Es importante tener en cuenta que cuando decide grabar su vXEN para participar en la subasta de grabación diaria para una asignación de XNF, se aplica una tarifa de grabación. De manera similar al proceso de grabación de vXEN, la grabación de sus tokens YSL también genera una tarifa de grabación. La tasa de conversión para adquirir un lote durante el proceso de grabación será fija, siendo un lote equivalente a 0.01 YSL (Arbitrum) o 10,000,000 vXEN. Al final del ciclo, recibirás tokens XNF según la cantidad total de lotes que quemaste.
...
Además de las tarifas de intercambio, los titulares de veXNF en las cadenas donde se ha implementado XNF también obtendrán tokens nativos al final de cada ciclo generado a partir de la tarifa de quema. Con XNF adoptando el modelo de reducción a la mitad y el 50% de la menta diaria reservada para aquellos que queman vXEN o YSL, participar en la subasta de quema diaria es uno de los pocos medios para asegurar una posición considerable en XNF. A medida que más usuarios queman vXEN e YSL para adquirir XNF, los titulares de veXNF no solo se benefician de mayores recompensas a través de la tarifa de quema, sino que el ecosistema se beneficia a través de una mayor proliferación de liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF. Esta innovadora implementación del ciclo de combustión crea otro ciclo de retroalimentación positiva, lo que garantiza que todo el ecosistema prospere mediante la participación activa de los usuarios.
...
Al alinear los valores de los lotes con los precios de los tokens nativos y ofrecer descuentos por volumen, nuestra fórmula de tarifa de quema permite la transparencia y al mismo tiempo fomenta la quema. Además, estamos orgullosos de enfatizar que el 100% de las tarifas de quema se redistribuyen para reforzar la liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF, respaldar el desarrollo continuo de Xenify y recompensar a los titulares de veXNF. Este enfoque no solo promueve la eficiencia sino que también reconoce las invaluables contribuciones de los miembros de nuestra comunidad, al tiempo que establece un ecosistema mutuamente beneficioso que fomenta la proliferación continua de liquidez.
...
enify adopta un enfoque estratégico para la asignación de tokens XNF todos los días, centrándose en recompensar a tres grupos de participantes clave dentro de los ecosistemas de todas las cadenas EVM en las que opera. Estos grupos se reconocen a través de un porcentaje predeterminado del total de tokens acuñados diariamente: el 50% se otorga a los usuarios que queman tokens vXEN o tokens YSL, el 45% a los contribuyentes de tokens nativos y el 5% final a aquellos involucrados en los intercambios de tokens.

Por ejemplo, con un volumen de acuñación diario de 20.000 tokens XNF, la asignación no se divide equitativamente de forma predeterminada, dadas las designaciones de porcentajes variables. En consecuencia, los quemadores de tokens vXEN e YSL aseguran 10,000 tokens XNF, lo que representa una participación del 50%. Los contribuyentes de tokens nativos reciben 9.000 tokens XNF, lo que corresponde a una asignación del 45%, mientras que los participantes del swap reciben una parte de 1.000 tokens XNF, lo que representa el 5% restante. Este proceso de distribución sistemático es uniforme en todas las cadenas de EVM, lo que garantiza recompensas justas y proporcionadas para las diversas actividades de los usuarios.
...
El protocolo calcula su parte del XNF diario asignado a las contribuciones de la tarifa de quema, teniendo en cuenta el total de tokens XNF distribuidos (TD), el número total de lotes quemados durante el ciclo (TB) y el número de lotes que quemó durante el ciclo (BB). Aquí se explica en detalle la fórmula para la asignación de grabación (BA) de vXEN:
...
<table>
    <tr>
        <td><strong>BA</strong><br>(Asignación de grabación)</td>
        <td>La cantidad de XNF que obtiene un usuario específico en función de los lotes quemados durante un ciclo.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>El número de lotes quemados durante un ciclo por el usuario específico cuya contribución a la quema se está calculando.</td>
    </tr>
    <tr>
        <td><strong>TB</strong><br>(lotes totales)</td>
        <td>El número combinado de lotes quemados por todos los usuarios durante un ciclo.</td>
    </tr>
</table>
...
Esta mecánica de reciclaje ofrece múltiples beneficios tanto para el ecosistema como para los recicladores. Permite a los usuarios participar en la subasta de quema diaria sin pagar el token de quema obligatorio y al mismo tiempo promueve la escasez del token XNF. Una parte de todas las recompensas recicladas se utiliza para generar liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF. Esta estrategia permite a los usuarios maximizar sus ganancias de una manera que respalde el crecimiento del protocolo.
...
Para aprovechar esta función de reciclaje, asegúrese de tener un saldo suficiente de recompensas de la cadena nativa para adquirir al menos un lote para el proceso de grabación. Si su saldo de recompensas no alcanza la cantidad requerida de tokens de cadena nativa, no podrá acceder a la opción de reciclaje. Al reciclar las recompensas de su cadena nativa, no solo fortalecerá su posición en XNF, sino que también disfrutará de un proceso simplificado que elimina las tarifas de quema habituales asociadas con la función de quema. Lo más importante es que, como reciclador dedicado, calificará para una distribución exclusiva de tokens nativos generados a partir de la tarifa de reclamo del 25% al reciclar dentro de la primera hora. Es una situación en la que todos ganan y que recompensa su participación activa y su compromiso con el crecimiento de Xenify.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⚡️ Ejemplo de recompensas por reciclaje

Veamos un ejemplo para ilustrar cómo funciona la función de reciclaje. Imagine que es titular de veXNF en Arbitrum y decide reciclar el saldo de recompensa de su cadena nativa de 1.0 ETH durante la primera hora del ciclo. Primero, el protocolo calcula su contribución a la quema. Dado que el valor del lote es 0.01 ETH en Arbitrum, sus recompensas de 1,0 ETH equivalen a 100 lotes. A continuación, su tarifa por quema se deduce de las recompensas según la fórmula de tarifa. Reciclar en la hora 1 significa que su tarifa de quema es 0.4975 ETH.
...
Durante cada ciclo, el grupo de recompensas del protocolo acumula gradualmente tokens nativos generados a partir de tarifas de quema, tarifas de intercambio y tarifas nativas. Este grupo crece con cada transacción, ya sea un intercambio o una quema. Luego, la suma total del fondo de recompensas se distribuye entre los titulares de veXNF en función de sus tenencias de XNF y su poder adquisitivo asociado. Si no hay titulares de veXNF al final del ciclo, las recompensas nativas generadas a partir de las tarifas de intercambio, las tarifas de quema y las tarifas nativas se utilizarán para crear liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF. Esta función se activará cada vez que un usuario participe en un ciclo cuando no haya titulares de veXNF y todos los bloqueos hayan expirado.

Además de las recompensas generadas por las tarifas de quema, las tarifas de intercambio y las tarifas nativas, el protocolo también realizará una distribución exclusiva de tokens nativos derivados de la tarifa de reclamo del 25% que se cobra cuando los titulares de veXNF reclaman sus recompensas nativas. Esta distribución exclusiva estará reservada para los titulares de veXNF que reciclen sus recompensas en la primera hora de un ciclo. Al alinear los incentivos y poner a trabajar las recompensas no utilizadas, Xenify crea un ecosistema próspero y sostenible que fomenta la participación y cultiva una base de usuarios en crecimiento, lo que ayuda a fortalecer el crecimiento a largo plazo del protocolo.
...
Presentamos los eventos de lanzamiento aéreo XNF exclusivos de Xenify, una iniciativa destinada a impulsar la participación de los usuarios en la plataforma en múltiples cadenas de EVM. Para generar anticipación para un próximo lanzamiento de XNF en una nueva cadena, un evento de lanzamiento aéreo precederá a su implementación. Los participantes serán recompensados con una generosa asignación de 1,500,000 tokens XNF durante cada evento, lo que brindará una oportunidad fantástica para beneficiarse del crecimiento de Xenify.

Estos 1,500,000 tokens XNF se distribuirán inicialmente como tokens bloqueados el día del lanzamiento y se desbloquearán gradualmente durante un período de 730 días. Por ejemplo, si recibe 7300 tokens XNF bloqueados del lanzamiento aéreo, puede esperar que se desbloqueen aproximadamente 10 tokens XNF en su billetera cada día. Dado que estos tokens se dividirán entre los participantes en función de sus contribuciones diarias previas al lanzamiento, cuanto más participes durante el evento, mayor será tu parte del XNF Airdrop. Ahora, entendemos su afán por ganar con esos tokens XNF y somos testigos del florecimiento de su cartera. Sin embargo, hay un pequeño inconveniente: los tokens XNF lanzados desde el aire no se pueden apostar hasta que se desbloqueen en su billetera. Por lo tanto, si su objetivo es ganar una parte de las recompensas nativas del protocolo, le recomendamos encarecidamente que también participe en la subasta inicial. ¡Es su boleto para ganar una parte de las recompensas nativas de la distribución inicial!
...
En Xenify la seguridad es primordial para garantizar la máxima seguridad y confiabilidad de nuestro protocolo. Para fortalecer la seguridad de nuestro protocolo, hemos realizado una auditoría de los contratos por parte de PeckShield y Solidproof, firmas de seguridad de gran prestigio en la industria. Nuestro protocolo está cuidadosamente diseñado teniendo como principios rectores la descentralización y la autonomía. Los contratos inteligentes de Xenify no tienen claves de administración, lo que significa que no pueden ser actualizados ni gobernados por una autoridad centralizada. Reforzar el carácter verdaderamente descentralizado y autónomo de nuestro protocolo.

A medida que Xenify evoluciona, nuestro objetivo es priorizar los intereses de nuestros usuarios, fomentando la transparencia y la confianza dentro del protocolo. La misión de Xenify es crear un protocolo DeFi transparente, equitativo y centrado en el usuario manteniendo los primeros principios de las criptomonedas en todos nuestros esfuerzos. Al adherirnos a estos valores fundamentales, nos esforzamos por construir un protocolo que personifique la confianza, la justicia y el desarrollo impulsado por la comunidad en el espacio DeFi.
...
- Los tokens XNF no serán preminados ni asignados a inversores o miembros del equipo. En cambio, los usuarios pueden adquirir tokens XNF interactuando activamente con el protocolo, ya sea quemando tokens vXEN o YSL, participando en la subasta nativa o intercambiando tokens de una cadena compatible. Este enfoque recompensa a los usuarios por sus contribuciones y garantiza una distribución justa de XNF dentro del ecosistema.
...
Lo que distingue a Xenify es su conexión sin fisuras con 60 agregadores diferentes, lo que permite realizar canjes con un solo clic y sin esfuerzo a precios inmejorables en 54 cadenas líderes. Sin embargo, su valor va más allá de la mera comodidad. Al distinguirse de otras bolsas, Xenify facilita la adopción por parte del usuario garantizando que cada acción realizada en la plataforma contribuya a un entorno recíproco en el que los beneficios se acumulan en función de las contribuciones y la implicación.
...
## ◽️ ¿Los contratos son de código abierto?
  - Nuestros contratos son de acceso abierto para su visualización, pero no tienen licencia. La redistribución, modificación o reutilización de nuestros contratos, total o parcialmente, está estrictamente prohibida sin el consentimiento explícito por escrito de todos los cofundadores. Las solicitudes de aprobación deben enviarse a las direcciones de correo electrónico oficiales de los cofundadores y recibir respuestas directas de estas direcciones. Estas restricciones existen para proteger los intereses de nuestros titulares.
...
## ◽️ ¿Qué hace el botón de reciclar?
- El botón de reciclaje es una función fácil de usar que prioriza las necesidades de los titulares de veXNF. Con solo hacer clic en este botón, los usuarios pueden convertir cómodamente sus recompensas acumuladas de la cadena nativa en XNF a través de la subasta diaria. Esta característica trae varias ventajas. En primer lugar, le permite participar en el ciclo de grabación sin incurrir en la tarifa de grabación obligatoria asociada con el proceso de grabación predeterminado. Esto significa que puede disfrutar de los beneficios de adquirir XNF durante el ciclo de grabación y, al mismo tiempo, ahorrar en tarifas adicionales.

- Además, al elegir reciclar tus recompensas, contribuyes activamente al crecimiento y la sostenibilidad del ecosistema Xenify. Después de deducir una tarifa de quema de las recompensas recicladas, el protocolo asigna el 90% de las recompensas restantes para crear liquidez propiedad del protocolo a través de los mecanismos de compra y quema de XNF, fomentando la escasez y un mercado más eficiente para el token. El 10% restante se desembolsa al equipo, lo que respalda los gastos operativos continuos, como el desarrollo de plataformas, campañas de marketing y actividades de participación comunitaria.

- Al reciclar sus recompensas, no solo mejora sus propios beneficios sino que también desempeña un papel vital en el éxito continuo de la plataforma Xenify. Como resultado, los recicladores calificarán para una distribución exclusiva adicional de tokens nativos generados a partir de las tarifas de reclamo de la plataforma cuando opten por reciclar durante la primera hora de un ciclo. Esto significa que al participar activamente en el proceso de reciclaje, tiene la oportunidad de obtener recompensas adicionales y, al mismo tiempo, aumentar sus tenencias generales de XNF.

- En conclusión, la función del botón de reciclaje no sólo ofrece comodidad sino que también presenta numerosas ventajas para los titulares de veXNF. Al ahorrar en tarifas, contribuir al crecimiento del ecosistema y acceder a recompensas exclusivas, los recicladores pueden maximizar sus beneficios y al mismo tiempo respaldar el éxito continuo de la plataforma Xenify.
...
## ◽️ Si bloqueo el XNF ahora, ¿cuándo recibiré las recompensas?
  ...
  - Esta mecánica de caída incentiva a los usuarios a bloquear por períodos más largos para mantener una mayor fuerza de ganancias por más tiempo. A lo largo de cada ciclo, las recompensas generadas a partir de las tarifas de quema, las tarifas de intercambio y las tarifas nativas se acumulan en un grupo de recompensas, y el protocolo distribuye todo el grupo de recompensas de tokens de la cadena nativa entre los titulares de veXNF al final del ciclo en función de sus tokens XNF bloqueados y su poder adquisitivo asociado, asegurando una distribución justa y transparente.
...
## ◽️ ¿Qué pasa si no hay participantes en las subastas diarias?
- En el improbable caso de que pase un ciclo sin ningún intercambio en Xenify y ningún usuario participe en la subasta de quema o subasta nativa, no se producirá la distribución del ciclo diario de XNF. Los tokens XNF que debían distribuirse durante este ciclo no se acuñarán. En consecuencia, la oferta total de XNF se reducirá en la cantidad prevista para su distribución en ese ciclo. Por ejemplo, si la asignación diaria para un ciclo se estableció en 20,000 XNF, y no se realizaron intercambios durante ese ciclo ni ningún token contribuyó a las subastas nativas y de quema, entonces estos 20,000 XNF no se acuñarán ni distribuirán. En cambio, la oferta total de XNF se reducirá en 20.000 XNF al final del ciclo.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ ¿Qué pasa si solo una o dos de las subastas diarias tienen participantes?
- La distribución XNF se realiza a través de tres subastas diarias. Cada día, el 50% de los tokens XNF se asignan a los participantes de la subasta. Además, el 50% del suministro diario de XNF está reservado para recompensas veXNF, y estas recompensas se bloquean durante un año antes de su distribución a los participantes en la subasta nativa (45%) y la subasta de intercambio (5%). En caso de que una o dos de las subastas diarias carezcan de participantes, el protocolo adapta la distribución diaria de XNF para garantizar la equidad.
  
- El protocolo está diseñado para redistribuir dinámicamente las recompensas entre diferentes escenarios: sin quemar participantes de la subasta, el 90% del XNF diario se destina a los participantes nativos de la subasta como recompensas veXNF y el 10% restante para intercambiar participantes de la subasta como recompensas veXNF; en ausencia de participantes en la subasta de swap, el 50% se distribuye como de costumbre para quemar a los participantes de la subasta y los participantes nativos de la subasta reciben el 50% restante como recompensas veXNF. Si no hay participantes nativos en la subasta, el 50% se distribuye como de costumbre para quemar participantes de la subasta y el 50% restante para intercambiar participantes de la subasta como recompensas veXNF. En ausencia de participantes de la subasta nativos y quemados, el 100% se destina a intercambiar participantes de la subasta como veXNF; Ningún participante de la subasta nativa y de intercambio significa el 100% para los participantes de la subasta de quema, y ningún participante de la subasta de intercambio y quema asigna el 100% a los participantes de la subasta nativos como recompensas veXNF.
  
- En resumen, cualquier subasta que tenga participantes obtiene recompensas. Este enfoque adaptativo garantiza que la actividad sea recompensada consistentemente, incluso en escenarios de baja participación en las subastas, promoviendo una distribución equilibrada y eficiente.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Si opto por bloquear mi XNF, ¿con qué frecuencia se compara la extensión de un bloqueo mínimo de 7 días con un bloqueo continuo de 1 año?
- Optar por bloquear su XNF durante un mínimo de 7 días y luego extenderlo repetidamente diariamente da como resultado un menor poder adquisitivo para su veXNF en comparación con bloquearlo continuamente durante 1 año. Por ejemplo, si usted y otro usuario bloquean la misma cantidad de XNF, pero usan extensiones mínimas de 7 días y ellos hacen un bloqueo de 1 año, su veXNF tendría un poder adquisitivo significativamente menor durante el año, aproximadamente 52 veces menos.

- Esto se debe a que la potencia inicial de su veXNF depende de la duración del bloqueo. Bloquear 1000 XNF durante 1 año produce 1000 veXNF con un programa de decadencia de 60 días. Un bloqueo de 6 meses produce 500 veXNF. Más tiempo bloqueado continuamente equivale a más potencia veXNF inicial. Tenga en cuenta que la potencia de veXNF disminuye con el tiempo, especialmente con bloqueos de un mínimo de 7 días que tienen un programa de caída rápida de 1,15 días frente a los 60 días de un bloqueo de 1 año. En resumen, extender con frecuencia bloqueos mínimos cortos de 7 días proporciona sustancialmente menos poder adquisitivo que bloqueos más largos y continuos de 1 año para la misma cantidad de XNF debido a la diferencia en la potencia inicial de veXNF y las tasas de caída.
...
- YSL ha sido diseñado para ser un token hiperdeflacionario, que combina escasez cuantificable y utilidad a través de las subastas diarias de Xenify. Con un suministro total fijo y un mecanismo de quema incorporado, YSL tiene el potencial de apreciar su valor con el tiempo a medida que disminuye el suministro circulante. YSL logra esto a través de su integración con la subasta de quema diaria de Xenify, que asigna XNF recién creado a los usuarios que optan por quemar sus tokens YSL. Esta constante fuente diaria de demanda de quema de tokens YSL genera una presión deflacionaria perpetua, a diferencia de otros tokens deflacionarios que dependen únicamente de la actividad comercial. En resumen, la tokenómica deflacionaria de YSL ofrece una oportunidad intrigante, con escasez codificada, utilidad e impulsores predecibles de crecimiento del valor.
...
## ◽️ Xenify
  ...
  - Xenify es un protocolo financiero descentralizado (DeFi) diseñado para revolucionar la experiencia del intercambio de tokens. Ofrece un agregador entre cadenas de última generación que facilita el intercambio de tokens entre 54 cadenas diferentes. Con acceso a las mejores rutas y las tarifas más bajas de 60 agregadores, Xenify permite a los usuarios intercambiar tokens sin problemas entre las cadenas compatibles. Hace hincapié en la equidad, la simplicidad, la transparencia, la capacitación de los usuarios y la interoperabilidad, con el objetivo de crear un ecosistema DeFi más conectado y fácil de usar.
...
## ♦️XNF
- [Árbitro](https://arbiscan.io/address/0xC84FaE1141B92Fa5Bf847276828f69cAF651Cb7F)

## ♦️vXEN
- [vXES](https://arbiscan.io/address/0x37bb209B118a22F233DEa252A5D7F56455765b4D)
