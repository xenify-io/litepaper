...
- [vXEN - Brûlures XEN inter-chaînes](https://github.com/xenify-io/litepaper/blob/main/Languages/French.md#%EF%B8%8F-vxen---br%C3%BBlures-xen-inter-cha%C3%AEnes)
- [vXNF – Gravures XNF inter-chaînes](https://github.com/xenify-io/litepaper/blob/main/Languages/French.md#%EF%B8%8F-vxnf---br%C3%BBlures-xnf-inter-cha%C3%AEnes)
...
- [Expérience de l'utilisateur](https://github.com/xenify-io/litepaper/blob/main/Languages/French.md#%EF%B8%8F-exp%C3%A9rience-de-lutilisateur)
...
- Les participants à l'enchère Swap reçoivent les 5% restants de l'offre XNF sous forme de récompenses veXNF, sous réserve du même verrouillage d'un an récupérable, améliorant ainsi leur pouvoir de gain lors de la réclamation.
...
- Pour promouvoir la croissance continue de la liquidité appartenant au protocole ETH, à partir du deuxième cycle, 70% de l'ETH (reçu des frais de gravure, des frais natifs, des frais de swap et 90% du recyclage) sera réinvesti dans l'expansion des liquidités appartenant au protocole. liquidité. Dans ce modèle, la totalité de la somme d’ETH collectée est canalisée vers l’achat et la gravure de XNF sur le marché. Simultanément, un montant équivalent de WETH est dirigé vers le pool appartenant au protocole, augmentant ainsi les réserves de WETH dans le pool de liquidité WETH-XNF et assurant un support étendu sur l'ensemble de la gamme.
...
- Xenify lancera un événement de largage sur chaque chaîne sur laquelle il opère. Tout au long de cette phase, 1,500,000 XNF seront distribués aux participants.

- Pour la chaîne BNB et l'Arbitrum, nos événements de largage de 60 jours comprendront l'attribution de 25,000 jetons XNF en fonction de la contribution de chaque participant via des frais de swap. Cela s'étend aux échanges effectués sur toutes les chaînes compatibles EVM prises en charge, garantissant une inclusivité généralisée. Pour être éligibles au largage, les transactions doivent provenir ou être effectuées sur une chaîne EVM, à condition que les participants aient choisi de payer les frais de swap de 0.5%.

- Une fois un événement de largage terminé, les destinataires auront la possibilité de réclamer leurs jetons XNF lors de son déploiement. Ces jetons parachutés se débloqueront progressivement sur 730 jours. Par exemple, si vous réclamez 7,300 jetons XNF verrouillés lors du largage, vous pouvez vous attendre à un déverrouillage d'environ 10 jetons XNF par jour dans votre portefeuille.
...
- XNF dispose d'une offre maximale de 22,6 millions de jetons. La distribution s'effectue au travers de trois enchères quotidiennes. Chaque jour, 50% des jetons XNF sont alloués aux participants aux enchères. De plus, 50% de l'offre quotidienne de XNF est réservée aux récompenses veXNF, ces récompenses étant verrouillées pendant un an avant d'être distribuées aux participants à l'enchère ETH (45%) et à l'enchère Swap (5%).
...
- vXEN permet aux participants de différentes chaînes EVM au sein de l'écosystème XEN de participer aux enchères de gravure quotidiennes. vXEN est généré en gravant des jetons natifs XEN à partir de l'une des neuf chaînes prises en charge dans l'écosystème XEN. Chaque fois qu'un détenteur grave du XEN natif à partir de l'une de ces chaînes, la transaction est enregistrée dans l'enregistrement de gravure. Voici une liste détaillée des chaînes EVM prises en charge, chacune avec son identifiant et son ratio correspondant pour un seul vXEN :
...
Cette approche gagnant-gagnant garantit la prolifération perpétuelle des liquidités appartenant au protocole grâce aux mécanismes d'achat et de combustion de XNF, quelles que soient les conditions du marché, tout en améliorant également les récompenses pour les participants dévoués au sein de l'écosystème Xenify. Grâce à ces incitations alignées qui capturent de la valeur pour tous les participants, Xenify cultive un écosystème prospère sur le long terme. De plus, au cœur de la philosophie de Xenify se trouve un engagement inébranlable en faveur de l'équité et de la transparence, incarné par notre modèle exemplaire de distribution de jetons. Avec une offre totale maximale de seulement 22 600 000 jetons XNF, il n'y aura aucune allocation pour l'équipe, les fondateurs ou les investisseurs. En fait, la seule façon d’acquérir des jetons XNF est de participer activement à l’écosystème. Cette approche garantit une distribution véritablement équitable des jetons XNF, récompensant les utilisateurs pour leurs contributions et favorisant un protocole axé sur la communauté.
...
De plus, Xenify intègre un ingénieux mécanisme de gravure qui permet aux utilisateurs de graver des jetons vXEN et YSL pour créer du XNF. Le processus de gravure de vXEN agit comme un graveur stratégique de couche 1, et voici la partie intéressante : 70% sont utilisés pour effectuer un rachat et une gravure automatisés de XNF, 25% des frais de gravure reviennent aux détenteurs de veXNF et les 5% restants sont envoyé à l'équipe Xenify. Cette approche encourage non seulement l'engagement des utilisateurs à long terme, mais améliore également la durabilité, tout en améliorant les récompenses pour ceux qui sont profondément impliqués dans le protocole.
...
- **21,000,000 XNF assignés aux enchères quotidiennes:** Les utilisateurs qui participent à diverses activités qui soutiennent le développement continu du protocole auront la chance de gagner une part des jetons XNF dédiés aux enchères quotidiennes.
  ...
  - 10,500,000 XNF (50%) sont distribués aux participants aux enchères de brûlage en fonction du nombre de lots brûlés au cours de chaque cycle.
    
  - 9,450,000 XNF (45%) sont distribués aux utilisateurs qui contribuent aux jetons natifs pour participer à la vente aux enchères quotidienne. Ces jetons XNF seront distribués aux participants sous la forme de veXNF, avec une période de blocage associée d'un an.

  - 1,050,000 XNF (5%) sont distribués aux utilisateurs qui s'engagent dans des swaps sur les chaînes EVM prises en charge. Ces jetons XNF seront distribués parmi les participants aux échanges sous la forme de veXNF, avec une période de blocage associée d'un an.

- **100,000 XNF affectés à la création du pool de liquidité Uniswap V3 :** Pour renforcer un écosystème robuste, 100,000 XNF seront mis de côté pour amorcer les liquidités appartenant au protocole au lancement. Cette initiative permettra à notre communauté d’échanger XNF en toute transparence dès le début. Pour faciliter cela, la majorité des frais générés par la participation au premier jour (y compris les frais de swap, les frais natifs et les frais de gravure) seront utilisés pour établir un pool de liquidité Uniswap V3 à la fin du cycle.

- **1,500,000 XNF attribués en tant que largage exclusif :** Pour encourager l'engagement, chaque chaîne bénéficiera d'un largage exclusif de 1,500,000 XNF avant le déploiement. Les participants pourront réclamer leur airdrop le premier jour du lancement et seront distribués sous forme de jetons verrouillés, déverrouillés progressivement sur 730 jours.
...
- Polygon sera déterminé après le déploiement de BNB Chain.

### 4️⃣ Ethereum (eXNF)

- Ethereum sera déterminé après le déploiement de Polygon.
...
Notre protocole est conçu pour assurer la croissance perpétuelle de la liquidité appartenant au protocole ETH à chaque cycle ultérieur. À partir du deuxième cycle, une grande partie de l’ETH obtenu quotidiennement – via les frais de brûlage, les frais natifs, les frais de swap et les activités de recyclage – sera utilisée pour soutenir la croissance de la liquidité des ETH. Dans ce cadre, l’ETH est utilisé pour acheter et brûler du XNF sur le marché ; simultanément, la quantité équivalente de WETH, qui a été utilisée pour le rachat et la gravure de XNF, est injectée dans le pool appartenant au protocole. Cette action entraîne une augmentation significative du WETH au sein du pool de liquidité WETH-XNF, garantissant une couverture complète sur l'ensemble de la gamme appartenant au protocole.
...
La distribution des jetons XNF suit des cycles d'une journée, commençant par un pool de récompenses de 20 000 jetons XNF. Cette allocation quotidienne est répartie de trois manières : 50% sont distribués aux utilisateurs qui gravent vXEN ou YSL, 45% sont distribués aux contributeurs de jetons natifs et les 5% restants sont répartis entre les contributeurs aux frais d'échange de la plateforme. Cette allocation quotidienne s'étendra également à toutes les autres chaînes de déploiement futures. Grâce à la mise en œuvre d'un modèle de réduction de moitié, la quantité quotidienne de frappe diminue progressivement, aboutissant à la distribution complète du total de 22,6 millions de jetons XNF d'ici le mois 2461.
...
Pour chaque lot brûlé, les tokens que vous fournissez (vXEN ou YSL) sont définitivement retirés de la circulation. Sur vos frais de gravure, 70% sont utilisés pour créer des liquidités appartenant au protocole via les mécanismes d'achat et de gravure de XNF, 25% sont distribués sous forme de récompenses natives entre les détenteurs de veXNF et les 5% restants sont envoyés à l'équipe Xenify. Ce mécanisme de gravure va au-delà de la simple réduction de l’offre en circulation de jetons XEN et YSL ; il incarne une approche stratégique qui unifie les communautés YSL et XEN au sens large à travers toutes les chaînes tout en soutenant la croissance de notre écosystème et en récompensant les participants actifs.
...
En plus des frais d'échange, les détenteurs de veXNF sur les chaînes où XNF a été déployé gagneront également des jetons natifs à la fin de chaque cycle générés par les frais de gravure. Alors que XNF adopte le modèle de réduction de moitié et que 50% de la monnaie quotidienne est réservée à ceux qui brûlent du vXEN ou du YSL, la participation aux enchères quotidiennes est l'un des rares moyens d'obtenir une position XNF importante. À mesure que de plus en plus d'utilisateurs brûlent vXEN et YSL pour acquérir XNF, non seulement les détenteurs de veXNF bénéficient de récompenses accrues grâce aux frais de gravure, mais l'écosystème bénéficie également d'une prolifération accrue des liquidités appartenant au protocole grâce aux mécanismes d'achat et de gravure de XNF. Cette mise en œuvre innovante du cycle de gravure crée une autre boucle de rétroaction positive, garantissant que l’ensemble de l’écosystème prospère grâce à la participation active des utilisateurs.
...
Xenify propose une solution révolutionnaire d'échange de jetons qui non seulement simplifie les transactions entre chaînes, mais récompense également ses utilisateurs, tout en favorisant l'expansion de son écosystème. Grâce à une commission de 0,5% sur chaque échange de jetons, Xenify est en mesure d'atteindre trois objectifs cruciaux : récompenser les utilisateurs de sa plateforme avec des jetons XNF, fournir des récompenses natives aux détenteurs de veXNF et assurer le développement continu du protocole.

Voici comment cela fonctionne : lorsqu'un utilisateur lance un échange de jetons sur Xenify, il peut choisir de payer des frais d'échange facultatifs de 0,5%. Ces frais sont stratégiquement alloués pour encourager la croissance future et encourager l’engagement des utilisateurs. Sur les chaînes où XNF a été déployé, 70% des frais de swap seront utilisés pour la prolifération des liquidités appartenant au protocole via les mécanismes d'achat et de combustion de XNF, 25% seront distribués sous forme de récompenses natives entre les détenteurs de veXNF, les 5% restants utilisé par l'équipe pour soutenir le développement continu de Xenify.

En payant les frais d'échange nominaux de 0,5% sur les chaînes où le XNF est déployé, vous n'accélérez pas seulement votre transaction, mais vous vous assurez également une allocation de XNF à partir du cycle de frappe quotidien du protocole. Ces jetons XNF sont bloqués pendant un an et distribués parmi les participants à l'échange sous le nom de veXNF. Ce jeton unique ERC-721 non fongible (NFT) représentera vos avoirs en XNF, qui pourront être retirés à la fin de la période de blocage.
...
Le protocole Xenify permet aux utilisateurs de brûler des jetons vXEN ou YSL pour obtenir des XNF à partir du cycle quotidien de récompense des XNF. En participant à l'enchère quotidienne de combustion pour acquérir des XNF, les utilisateurs devront faire face à certains coûts tels que les frais de gaz de transaction et les frais de combustion obligatoires. Cependant, le calcul des frais de combustion a été soigneusement conçu pour non seulement assurer une méthode transparente et cohérente pour la combustion des jetons, mais aussi pour récompenser les utilisateurs avec une réduction attrayante pouvant aller jusqu'à 75%.
...
<table>
    <tr>
        <td><strong>VP</strong><br>(Valeur par lot)</td>
        <td>La valeur par lot qui est définie pour la chaîne.</td>
    </tr>
    <tr>
...
Voici comment cela fonctionne : La valeur par lot est calculée comme 10 élevé à la puissance de (2 - ND), où ND est le nombre de chiffres avant la décimale dans le prix du jeton natif. Cette formule crée une valeur de lot qui reste cohérente par rapport au prix du jeton natif. Lorsque la valeur du jeton natif est élevée, la valeur par lot fixée lors du déploiement sera proportionnellement plus faible afin de garantir une commission de combustion appropriée pour la chaîne.

Ce mécanisme permet de s'assurer que les frais de combustion restent cohérents entre les différentes chaînes où Xenify se déploie, en particulier pour les chaînes avec des jetons natifs plus chers. Par exemple, la valeur d'un lot sur Arbitrum sera fixée à 0,01 ETH lors du déploiement, puisque l'ETH a 4 chiffres avant la virgule à sa valeur de marché actuelle. Cependant, lorsque Xenify se déploie sur BNB Chain, la valeur d'un lot sera fixée à 0,1 BNB, puisque BNB a 3 chiffres avant la virgule à sa valeur actuelle supérieure à 100 $.

En alignant les valeurs des lots sur les prix natifs des jetons et en offrant des remises sur volume, notre formule de frais de gravure permet la transparence tout en encourageant la gravure. De plus, nous sommes fiers de souligner que 100% des frais de gravure sont redéployés pour renforcer la liquidité appartenant au protocole via les mécanismes d'achat et de gravure de XNF, soutenir le développement continu de Xenify et récompenser les détenteurs de veXNF. Cette approche favorise non seulement l'efficacité, mais reconnaît également les contributions inestimables des membres de notre communauté, tout en établissant un écosystème mutuellement bénéfique qui favorise la prolifération continue des liquidités.

De plus, avec une réduction maximale de 75% pour 10 000 lots, plus les utilisateurs brûlent, plus ils économisent ! Cette opportunité offre non seulement des avantages substantiels à ceux qui s'engagent dans la combustion, mais génère également des récompenses accrues pour les détenteurs de veXNF. Il s'agit d'un scénario gagnant-gagnant qui encourage l'implication active dans l'écosystème Xenify tout en garantissant la création de valeur pour tous les participants.
...
Le calcul des frais de combustion (BF) comprend des facteurs pondérés en fonction du temps, appelés coefficient de temps (TC) et coefficient de lot (BC), qui aident à déterminer les frais nécessaires pour exécuter la fonction de combustion en fonction de la valeur des lots brûlés. La réduction des frais de combustion que vous obtiendrez dépendra du coefficient de temps (TC) et du coefficient de lot (BC) applicables lorsque vous brûlez au cours d'un cycle. Ces deux coefficients sont pondérés en fonction du temps et diminuent tout au long du cycle quotidien. Cela signifie que la réduction effective que vous obtiendrez variera en fonction du moment où vous déciderez de brûler au cours d'un cycle.

Pour lancer la fonction de combustion sur Xenify, les utilisateurs doivent disposer d'un solde de portefeuille suffisant en jetons de la chaîne native qui atteint ou dépasse le montant requis pour les frais de combustion. Le protocole calculera les frais de combustion (BF) en utilisant la formule ci-dessous :
...
<table>
    <tr>
        <td><strong>BF</strong><br>(Frais de combustion)</td>
        <td>Les frais facturés pour la fonction de brûlage, payés dans le jeton natif de la chaîne.</td>
    </tr>
    <tr>
        <td><strong>TC</strong><br>(Coefficient de temps)</td>
        <td>Coefficient pondéré en fonction du temps utilisé pour tenir compte d'une réduction basée sur le moment où la combustion est exécutée au cours d'un cycle.</td>
    </tr>
    <tr>
        <td><strong>VB</strong><br>(Valeur des lots)</td>
        <td>La valeur des lots brûlés par l'utilisateur. La valeur par lot sera fixe et variera en fonction de la chaîne.
    </tr>
    <tr>
        <td><strong>BC</strong><br>(Coefficient de lot)</td>
        <td>Coefficient pondéré dans le temps utilisé pour prendre en compte la remise en fonction des lots brûlés.</td>
    </tr>
    <tr>
...
## ⭐️ Coefficient de temps (TC)

Les frais de brûlage (BF) nécessaires pour exécuter la fonction de brûlage augmenteront à mesure que la valeur totale des lots brûlés augmentera. Toutefois, en exécutant les brûlages plus tôt dans le cycle, les utilisateurs ont la possibilité de bénéficier de frais de brûlage moins élevés grâce au coefficient de temps (TC).

Comme le montre le tableau ci-dessous, le coefficient de temps commence à 50% au début d'un cycle et augmente d'environ 2,174% toutes les heures jusqu'à atteindre 100% au cours de la dernière heure du cycle quotidien. Cela signifie que les utilisateurs devront contribuer davantage à l'exécution de la fonction de brûlage au fil de la journée. Cependant, cela permet également aux utilisateurs qui brûlent plus tôt dans le cycle d'obtenir une réduction allant jusqu'à 75% au cours de la première heure de chaque cycle.
...
Supposons que vous décidiez de brûler 10 000 lots pendant la première heure du cycle quotidien sur Arbitrum, où la valeur par lot est fixée à 0,01 ETH. En tenant compte du fait que le coefficient de lot (BC) pendant la première heure d'un cycle est de 0,00005 et que le coefficient de temps (TC) pendant la première heure est de 50%, le protocole déterminera vos frais de combustion (BF) comme étant de 25 ETH.
...
Supposons que vous décidiez de brûler 10,000 lots au cours de la dernière heure du cycle quotidien sur Arbitrum, où la valeur par lot est fixée à 0.01 ETH. En tenant compte du fait que le coefficient de lot (BC) pendant la dernière heure d'un cycle est de 0 et que le coefficient de temps (TC) pendant la dernière heure est de 100%, le protocole déterminera vos frais de combustion (BF) comme étant de 100 ETH.
...
Xenify adopte une approche stratégique pour attribuer chaque jour des jetons XNF, en se concentrant sur la récompense de trois groupes de participants clés au sein des écosystèmes de toutes les chaînes EVM sur lesquelles elle opère. Ces groupes sont reconnus grâce à un pourcentage prédéterminé du total quotidien des jetons émis : 50% sont accordés aux utilisateurs brûlant des jetons vXEN ou des jetons YSL, 45% aux contributeurs de jetons natifs et les 5% restants à ceux impliqués dans les échanges de jetons.

Par exemple, avec un volume de frappe quotidien de 20 000 jetons XNF, l'allocation n'est pas répartie également par défaut, compte tenu des désignations de pourcentage variable. Par conséquent, les brûleurs de jetons vXEN et YSL sécurisent 10 000 jetons XNF, ce qui représente une part de 50%. Les contributeurs de jetons natifs se voient attribuer 9 000 jetons XNF, ce qui correspond à une allocation de 45%, tandis que les participants au swap reçoivent une part de 1 000 jetons XNF, soit les 5% restants. Ce processus de distribution systématique est uniforme dans toutes les chaînes EVM, garantissant des récompenses justes et proportionnées pour les diverses activités des utilisateurs.
...
Le protocole calcule votre part du XNF quotidien alloué aux contributions aux frais de gravure, en prenant en compte le total des tokens XNF distribués (TD), le nombre total de lots brûlés au cours du cycle (TB) et le nombre de lots que vous avez brûlés pendant le cycle (BB). Voici la formule pour l'allocation de gravure vXEN (BA) expliquée en détail :
...
<table>
    <tr>
        <td><strong>BA</strong><br>(Allocation de gravure)</td>
        <td>La quantité de XNF qu'un utilisateur spécifique obtient en fonction des lots brûlés au cours d'un cycle.</td>
    </tr>
    <tr>
        <td><strong>TD</strong><br>(Total distribué)</td>
        <td>Nombre total de jetons XNF distribués entre les utilisateurs au cours d'un cycle spécifique.</td>
    </tr>
    <tr>
        <td><strong>BB</strong><br>(Lots brûlés)</td>
        <td>Nombre de lots brûlés au cours d'un cycle par l'utilisateur spécifique dont la contribution à la gravure est en cours de calcul.</td>
    </tr>
    <tr>
        <td><strong>To</strong><br>(Nombre total de lots)</td>
        <td>Nombre combiné de lots gravés par tous les utilisateurs au cours d'un cycle.</td>
    </tr>
</table>

<br>

Voici comment cela fonctionne : Le protocole calcule l'allocation de gravure (BA) de l'utilisateur en multipliant d'abord le total des jetons XNF devant être distribués pour le cycle (TD) par 50%, puisque 50% de la menthe quotidienne XNF est allouée aux participants qui brûlent. vXEN ou YSL. Il calcule ensuite la proportion de lots brûlés par l'utilisateur spécifique (BB) par rapport au nombre total de lots brûlés par tous les utilisateurs (TB), ce qui donne une valeur par lot brûlé. Enfin, le protocole multiplie ces valeurs pour déterminer l'allocation de gravure individuelle de l'utilisateur pour ce cycle (BA).

De même, le protocole calcule votre allocation de swap (SA) pour un cycle, en prenant en compte le total des jetons XNF dont la distribution est prévue pour le cycle (TD), le total des frais de swap payés par tous les utilisateurs pendant le cycle (TSF), et les frais de swap que vous avez payés pendant le cycle (USF). Voici la formule expliquée en détail :
...
<table>
    <tr>
        <td><strong>SA</strong><br>(Allocation de swap)</td>
        <td>L'allocation XNF pour un utilisateur spécifique sur la base de ses contributions aux frais de swap au cours d'un cycle.</td>
    </tr>
    <tr>
        <td><strong>TD</strong><br>(Total distribué)</td>
        <td>Le nombre total de jetons XNF qui sont distribués parmi les utilisateurs au cours d'un cycle spécifique.</td>
    </tr>
    <tr>
        <td><strong>USF</strong><br>(Frais d'échange de l'utilisateur)</td>
        <td>Les frais d'échange payés par un utilisateur spécifique au cours d'un cycle.</td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td><strong>NA</strong><br>(Allocation native)</td>
        <td>L'allocation XNF pour un utilisateur spécifique sur la base de ses contributions en jetons natifs au cours d'un cycle.</td>
    </tr>
    <tr>
        <td><strong>TD</strong><br>(Total distribué)</td>
        <td>Le nombre total de jetons XNF qui sont distribués parmi les utilisateurs au cours d'un cycle spécifique.</td>
    ...
    <tr>
        ...
        <td>Le nombre de lots contribués par des jetons natifs par un utilisateur spécifique au cours d'un cycle.</td>
    </tr>
    <tr>
...
## ⭐️ Verrouillage des jetons XNF

Les jetons XNF verrouillés jouent un rôle essentiel dans l'accumulation de récompenses natives pour les utilisateurs, la part de chaque utilisateur étant déterminée par sa position veXNF et la capacité de gain associée. Vos jetons XNF commencent à accumuler des récompenses natives au cours du même cycle que celui où ils sont verrouillés. Ces récompenses sont rassemblées dans un pool de récompenses au cours de chaque cycle, puis distribuées aux détenteurs de veXNF par le protocole à la fin du cycle quotidien. Les utilisateurs qui gagnent des XNF grâce à leurs contributions aux frais de swap ne seront pas obligés de verrouiller leurs XNF, car le protocole verrouille automatiquement leur allocation de XNF pour la période de verrouillage maximale d'un an et permet à l'utilisateur de gagner des récompenses natives sur un calendrier de décroissance de 60 jours.

D'autre part, les utilisateurs qui gagnent des XNF par le biais de contributions de frais de combustion et de recyclage devront verrouiller manuellement leurs jetons XNF s'ils souhaitent gagner une part des récompenses natives. Ce faisant, ils verrouillent leurs XNF pour une période de verrouillage choisie, qui peut être aussi courte qu'une semaine ou aussi longue qu'un an. Une fois que la période de verrouillage souhaitée a été définie, le XNF de l'utilisateur est verrouillé en fonction de la période choisie. Ensuite, le protocole frappe un NFT veXNF pour l'utilisateur, reflétant le montant du XNF verrouillé et la période de verrouillage choisie. Tout au long de la période de blocage, les utilisateurs ne peuvent pas déverrouiller leur XNF mais continuent d'accumuler des récompenses natives basées sur la capacité de gain de leur veXNF.

La capacité de gain d'un utilisateur diminuera de façon linéaire selon un calendrier de décroissance. Ce calendrier de décroissance dépendra de la période de blocage choisie par l'utilisateur et sera fixé à un maximum de 60 jours pour une période de blocage d'un an. Cela permet au protocole d'échelonner linéairement le calendrier de décroissance entre un minimum de 1,15 jour (pour un verrouillage de 7 jours) et un maximum de 60 jours (pour un verrouillage de 365 jours) en fonction de la durée de verrouillage choisie par l'utilisateur. Plus la durée de verrouillage est longue, plus le calendrier de désintégration est long, allant de 1,16 à 60 jours. Le calendrier de décroissance de la capacité de gain veXNF d'un utilisateur sera déterminé par le protocole à l'aide de la formule ci-dessous :
...
<table>
    <tr>
        <td><strong>DS</strong><br>(Calendrier de décroissance)</td>
        <td>Le calendrier de décroissance de la capacité bénéficiaire de veXNF.</td>
    </tr>
    <tr>
        <td><strong>MD</strong><br>(Décroissance maximale)</td>
        <td>Le calendrier de décroissance maximale de 60 jours.</td>
    </tr>
    <tr>
        <td><strong>LD</strong><br>(Durée de verrouillage)</td>
        <td>La durée de verrouillage choisie par l'utilisateur en jours.</td>
    </tr>
    <tr>
...
Plus longtemps vous bloquez votre FXF, plus votre capacité de gain en FXF est élevée. Cependant, il est important de noter que cette capacité de gain diminue avec le temps, même si vous optez pour la période de blocage maximale d'un an. Ce mécanisme de décroissance incite les utilisateurs à verrouiller pour des durées plus longues afin de conserver plus longtemps un pouvoir de gain plus élevé. Votre potentiel de gain est directement lié au montant de XNF que vous bloquez et à la durée de blocage que vous avez choisie. Au début de votre période de blocage, votre veXNF est frappé d'une capacité de gain de 100%. Au fil du temps, au fur et à mesure que votre blocage se prolonge, cette capacité de gain diminue, comme l'illustre la formule personnalisée ci-dessous :
...
<table>
    <tr>
        <td><strong>CP</strong><br>(Puissance actuelle)</td>
        <td>La capacité de gain veXNF actuelle des utilisateurs en pourcentage.</td>
    </tr>
    <tr>
        <td><strong>IP</strong><br>(Puissance initiale)</td>
        <td>Une capacité de gain veXNF initiale de 100% est fixée par le protocole au début du calendrier de désintégration.</td>
    </tr>
    <tr>
        <td><strong>TE</strong><br>(Temps écoulé)</td>
        <td>Le temps qui s'est écoulé depuis le début du programme de désintégration (limité à un maximum de 60 jours).</td>
    </tr>
    <tr>
...
## ⭐️ Différents scénarios de capacité de gain

Examinons de plus près le fonctionnement de la diminution de la capacité de gain dans différents scénarios :

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⚡️ Scénario 1 : l'utilisateur bloque XNF pendant 1 semaine

Supposons que vous décidiez de bloquer votre XNF pour la durée minimale d'une semaine. Au bout d'un jour, votre capacité bénéficiaire serait passée de 100% à 13,04%.
...
## ⚡️ Scénario 2 : L'utilisateur bloque XNF pendant 1 an

Supposons que vous décidiez de bloquer votre XNF pour la durée maximale d'un an. Au bout d'un jour, votre capacité bénéficiaire serait passée de 100% à 98,3%.
...
La comparaison de ces scénarios met en évidence les avantages d'une immobilisation de longue durée. Après seulement un jour de blocage d'un an, votre capacité de gain diminue à peine de 1,7% pour atteindre 98,3%. En revanche, si vous bloquez vos jetons XNF pendant une semaine, votre capacité de gain diminue beaucoup plus rapidement. Après seulement un jour, votre capacité de gain chutera de 86,96% à 13,04%. Cela démontre que le verrouillage pour des périodes plus longues préserve votre capacité de gain plus longtemps.

Ce modèle récompense les participants à long terme et aligne les incitations sur le soutien du protocole. Pour maintenir ou augmenter votre capacité de gain, vous pouvez toujours ajouter des jetons XNF à votre position veXNF ou prolonger la durée de votre verrou si nécessaire. Gardez à l'esprit que le montant des récompenses que vous recevez à la fin de chaque cycle dépend de votre part de la capacité de gain totale de tous les détenteurs de veXNF. Plus vous avez bloqué de XNF et plus votre capacité de gain est élevée, plus vous gagnez de récompenses.


![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⭐️ Déverrouillage des jetons XNF

Chez Xenify, nous offrons à nos utilisateurs une grande flexibilité dans la gestion de leur position en veXNF, avec la possibilité d'étendre, de fusionner et même de diviser les positions. Après avoir terminé la période de blocage choisie, vous aurez la possibilité de déverrouiller vos jetons XNF. Il est important de noter que le déverrouillage n'est possible qu'après la fin de votre période de blocage - votre XNF reste bloqué pendant la durée que vous avez choisie. Tout au long de votre cycle de verrouillage, vous accumulez des récompenses natives basées sur la quantité de XNF verrouillés et votre capacité de gain en veXNF. Cette capacité de gain diminue linéairement selon un calendrier de décroissance jusqu'à ce qu'elle atteigne zéro à la fin. À ce moment-là, vous cessez de gagner des récompenses sur votre position verrouillée, car votre capacité de gain en veXNF est épuisée.

Vous avez maintenant deux options : Soit prolonger votre période de blocage (de 1 semaine à 1 an) pour rétablir votre capacité de gain en veXNF et continuer à recevoir des récompenses. Soit attendre l'expiration de votre blocage actuel, puis le débloquer pour récupérer vos jetons XNF. La décision dépend de votre situation et de vos préférences. Si vous prolongez votre verrouillage, votre veXNF est réactivé à 100%, ce qui déclenche un nouveau calendrier de désintégration. Cela vous permet de continuer à bénéficier des récompenses liées à votre XNF verrouillé. Par ailleurs, si vous attendez l'expiration de votre verrou, vous pouvez déverrouiller et/ou vendre vos jetons. Cependant, vous ne gagnerez pas de récompenses dans l'intervalle.
...
Cette mécanique de recyclage offre de multiples bénéfices tant à l’écosystème qu’aux recycleurs. Il permet aux utilisateurs de participer aux enchères quotidiennes de gravure sans payer le jeton de gravure obligatoire tout en favorisant la rareté du jeton XNF. Une partie de toutes les récompenses recyclées est utilisée pour générer des liquidités appartenant au protocole grâce aux mécanismes d'achat et de gravure de XNF. Cette stratégie permet aux utilisateurs de maximiser leurs revenus d'une manière qui soutient la croissance du protocole.
...
Pour tirer parti de cette fonctionnalité de recyclage, assurez-vous de disposer d'un solde suffisant de récompenses de chaîne natives pour acquérir au moins un lot pour le processus de gravure. Si votre solde de récompense est inférieur au nombre requis de jetons de chaîne natifs, l'option de recyclage ne vous sera pas accessible. En recyclant vos récompenses de chaîne natives, vous renforcerez non seulement votre position XNF, mais profiterez également d'un processus rationalisé qui élimine les frais de gravure habituels associés à la fonction de gravure. Plus important encore, en tant que recycleur dédié, vous aurez droit à une distribution exclusive de jetons natifs générés à partir des frais de réclamation de 25% en recyclant dans la première heure. C'est une situation gagnant-gagnant qui récompense votre participation active et votre engagement envers la croissance de Xenify.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⚡️ Exemple de récompenses pour le recyclage

Passons en revue un exemple pour illustrer le fonctionnement de la fonctionnalité de recyclage. Imaginez que vous êtes détenteur de veXNF sur Arbitrum et que vous décidez de recycler votre solde de récompense en chaîne natif de 1,0 ETH pendant la première heure du cycle. Tout d’abord, le protocole calcule votre contribution aux brûlures. Étant donné que la valeur du lot est de 0,01 ETH sur Arbitrum, vos récompenses de 1,0 ETH équivalent à 100 lots. Ensuite, vos frais de gravure sont déduits des récompenses en fonction de la formule de frais. Le recyclage en heure 1 signifie que vos frais de gravure sont de 0.4975 ETH.
...
Une fois les frais de gravure prélevés, 70% sont utilisés pour créer des liquidités appartenant au protocole grâce aux mécanismes d'achat et de gravure de XNF. De plus, 25% de ces frais sont réservés à la distribution aux détenteurs de veXNF à la fin du cycle, tandis que l'équipe reçoit les 5% restants. À partir de vos récompenses, le montant réduit de 0,5025 ETH est alloué, 90% (0,45225 ETH) contribuant à la liquidité appartenant au protocole de XNF via le même mécanisme de gravure, et 10% (0,05025 ETH) allant à l'équipe Xenify. En contribuant au burn de 100 lots, vous recevez XNF à la fin du cycle. De plus, en recyclant les récompenses au cours de la première heure du cycle, vous gagnez une partie de l'ETH accumulé grâce aux frais de réclamation de 25%.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ⭐️ Distribution des récompenses en jetons natifs

Au cours de chaque cycle, le pool de récompenses du protocole accumule progressivement des jetons natifs générés par les frais de gravure, les frais de swap et les frais natifs. Ce pool s'agrandit à chaque transaction, qu'il s'agisse d'un swap ou d'un burn. La somme totale de la cagnotte de récompense est ensuite distribuée entre les détenteurs de veXNF en fonction de leurs avoirs en XNF et de la puissance de gain associée. S'il n'y a pas de détenteurs de veXNF à la fin du cycle, les récompenses natives générées par les frais de swap, les frais de burn et les frais natifs seront utilisées pour créer des liquidités appartenant au protocole via les mécanismes d'achat et de gravure de XNF. Cette fonction sera déclenchée chaque fois qu'un utilisateur participe à un cycle lorsqu'il n'y a aucun détenteur de veXNF et que tous les verrous ont expiré.

En plus des récompenses générées par les frais de gravure, les frais de swap et les frais natifs, le protocole effectuera également une distribution exclusive de jetons natifs dérivés des frais de réclamation de 25% prélevés lorsque les détenteurs de veXNF réclament leurs récompenses natives. Cette distribution exclusive sera réservée aux détenteurs de veXNF qui recyclent leurs récompenses dans la première heure d'un cycle. En alignant les incitations et en mettant à profit les récompenses inutilisées, Xenify crée un écosystème prospère et durable qui encourage l'engagement et cultive une base d'utilisateurs croissante, contribuant ainsi à renforcer la croissance à long terme du protocole.
...
<p align="center" dir="auto">
  <picture>
    <source media="(prefers-color-scheme: light)" srcset="https://github.com/xenify-io/litepaper/assets/66044824/caba21dd-06e4-4c38-9d8b-82de59e7b97b" class="source-light">
    <source media="(prefers-color-scheme: dark)" srcset="https://github.com/xenify-io/litepaper/assets/66044824/dd91930f-5233-41e7-b959-56c1c99657e9" class="source-dark">
...
Présentation des événements de largage aérien XNF exclusifs de Xenify, une initiative visant à stimuler l'engagement des utilisateurs sur la plate-forme sur plusieurs chaînes EVM. Pour anticiper un lancement prochain de XNF sur une nouvelle chaîne, un événement de largage précédera son déploiement. Les participants seront récompensés par une allocation généreuse de 1,500,000 jetons XNF lors de chaque événement, offrant ainsi une fantastique opportunité de bénéficier de la croissance de Xenify.

Ces 1,500,000 jetons XNF seront initialement distribués sous forme de jetons verrouillés le jour du lancement, puis déverrouillés progressivement sur une période de 730 jours. Par exemple, si vous recevez 7 300 jetons XNF verrouillés lors du largage, vous pouvez vous attendre à ce qu'environ 10 jetons XNF soient déverrouillés dans votre portefeuille chaque jour. Étant donné que ces jetons seront répartis entre les participants en fonction de leurs contributions quotidiennes jusqu'au lancement, plus vous participez pendant l'événement, plus votre part du XNF Airdrop sera importante ! Nous comprenons désormais votre désir de gagner de l’argent grâce à ces jetons XNF et voyons votre portefeuille prospérer. Cependant, il y a un petit problème : les jetons XNF Airdropped ne peuvent pas être mis en jeu tant qu'ils ne sont pas déverrouillés dans votre portefeuille. Ainsi, si vous souhaitez gagner une part des récompenses natives du protocole, nous vous recommandons fortement de participer également à l'enchère initiale de gravure. C'est votre ticket pour gagner une partie des récompenses natives de la distribution initiale !

Afin de garantir l'équité et de décourager le sniping de dernière minute, une allocation quotidienne cohérente de l'airdrop sera mise en œuvre tout au long de l'événement. Cela garantit que les participants reçoivent une part de l'airdrop qui reflète leur niveau d'engagement. Par exemple, pendant les 60 jours de l'airdrop Genesis sur la chaîne BNB, 25 000 jetons XNF seront alloués chaque jour. Votre part de l'airdrop Genesis sera basée sur vos contributions quotidiennes par le biais des frais d'échange. Imaginez que vous soyez le seul utilisateur à échanger un jour donné pendant les 60 jours de l'événement - vous recevrez un montant impressionnant de 25 000 XNF de l'airdrop ! De plus, pour maintenir l'engagement, les contributions faites pendant un événement ne seront pas reportées sur les airdrops suivants. Cette politique permet de s'assurer que les utilisateurs qui ne contribuent qu'une fois ne sont pas systématiquement inclus dans les airdrops suivants, ce qui favorise la participation active.
...
Se distinguant des bourses décentralisées traditionnelles, Xenify élimine la nécessité pour les utilisateurs de fournir des liquidités. Au lieu de cela, il fonctionne comme un agrégateur inter-chaînes, exploitant les API pour obtenir les taux de change les plus favorables et des frais minimes auprès de plusieurs bourses décentralisées. Cette approche simplifie l'expérience de l'utilisateur et facilite les transactions transparentes en un seul clic sur différents réseaux de blockchain. Les utilisateurs peuvent s'engager activement avec Xenify à travers une gamme de fonctions, y compris les échanges de jetons, la combustion de vXEN ou YSL, le verrouillage ou le déverrouillage de XNF, et le recyclage ou la réclamation de récompenses. La plateforme offre non seulement une expérience fluide aux utilisateurs, mais les récompense aussi activement pour l'utilisation du protocole par le biais de la distribution quotidienne du cycle de récompense.

Ce modèle d'incitation garantit que les utilisateurs de Xenify sont constamment reconnus pour leur participation et encourage l'utilisation continue de la plateforme. En outre, les utilisateurs peuvent surveiller leur position XNF et les récompenses accumulées, ce qui leur permet de réclamer ou de débloquer facilement leurs jetons XNF en quelques clics. En adoptant cette approche centrée sur l'utilisateur, Xenify reste accessible aux utilisateurs novices comme aux plus expérimentés.
...
Chez Xenify, la sécurité est primordiale pour garantir la plus grande sécurité et fiabilité de notre protocole. Pour renforcer la sécurité de notre protocole, nous avons mené un audit des contrats par PeckShield et Solidproof, des sociétés de sécurité très réputées dans l'industrie. Notre protocole est soigneusement conçu avec la décentralisation et l’autonomie comme principes directeurs. Les contrats intelligents de Xenify sont exempts de clés d'administration, ce qui signifie qu'ils ne peuvent pas être mis à niveau ou gouvernés par une autorité centralisée. Renforcer le caractère véritablement décentralisé et autonome de notre protocole.

À mesure que Xenify évolue, nous visons à donner la priorité aux intérêts de nos utilisateurs, en favorisant la transparence et la confiance au sein du protocole. La mission de Xenify est de créer un protocole DeFi transparent, équitable et centré sur l'utilisateur en respectant les premiers principes de la cryptographie dans tous nos efforts. En adhérant à ces valeurs fondamentales, nous nous efforçons de construire un protocole qui incarne la confiance, l'équité et le développement communautaire dans l'espace DeFi.
...
- Les jetons XNF ne seront pas pré-exploités ni attribués aux investisseurs ou aux membres de l'équipe. Au lieu de cela, les utilisateurs peuvent acquérir des jetons XNF en s'engageant activement dans le protocole, que ce soit en gravant des jetons vXEN ou YSL, en participant à l'enchère native ou en échangeant des jetons d'une chaîne prise en charge. Cette approche récompense les utilisateurs pour leurs contributions et garantit une répartition équitable de XNF au sein de l'écosystème.
...
Xenify, un agrégateur d'agrégateurs inter-chaînes, a été méticuleusement construit à partir de la base pour transformer la façon dont les utilisateurs s'engagent dans les échanges de jetons. Son objectif principal est d'offrir une expérience utilisateur transparente, de récompenser les membres actifs de la communauté et d'établir un modèle de distribution de jetons équitable et durable. En exploitant la tokenomique innovante, Xenify aspire à établir une plateforme décentralisée et communautaire qui valorise et encourage la participation active des utilisateurs au sein de l'écosystème.

Xenify se distingue par sa connexion transparente à 60 agrégateurs différents, ce qui permet d'échanger en un seul clic et sans effort des billets à des taux imbattables dans 54 grandes chaînes. Cependant, sa valeur va au-delà de la simple commodité. Se distinguant des autres échanges, Xenify facilite l'adoption par les utilisateurs en veillant à ce que chaque action effectuée sur la plateforme contribue à un environnement réciproque où les avantages s'accumulent en fonction des contributions et de l'implication.

Avec Xenify, les utilisateurs ont l'opportunité exclusive de gagner des jetons XNF sur chaque échange, complétée par un modèle de verrouillage innovant qui permet aux utilisateurs de gagner des jetons de la chaîne native tels que ETH, BNB et MATIC sur une base quotidienne. Ce modèle d'incitation unique positionne indéniablement Xenify comme le premier choix pour ceux qui cherchent à simplifier le processus d'échange entre chaînes tout en maximisant leur potentiel de gain.
...
- Nos contrats sont librement accessibles pour visualisation mais ne sont pas sous licence. La redistribution, la modification ou la réutilisation de nos contrats, en tout ou en partie, est strictement interdite sans le consentement écrit explicite de tous les co-fondateurs. Les demandes d'approbation doivent être envoyées aux adresses e-mail officielles des co-fondateurs et recevoir des réponses directes de ces adresses. Ces restrictions sont en place pour protéger les intérêts de nos détenteurs.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Le XNF a-t-il une offre initiale ?
  - Non, Xenify n'a pas d'approvisionnement initial et il n'y a pas de pré-mine de jetons XNF. Au lieu de cela, le protocole récompense quotidiennement les utilisateurs pour leur participation active à l’écosystème. Ceci est réalisé grâce à diverses contributions, telles que les contributions aux frais de gravure effectuées en gravant directement des jetons vXEN ou YSL, les contributions aux jetons natifs, ainsi que les frais de swap générés via l'agrégateur Xenify. Notamment, 25% des frais de brûlage, des frais de swap et des frais natifs sont collectés sur les chaînes EVM prises en charge et sont dirigés quotidiennement vers les détenteurs de veXNF, offrant un potentiel de gains important à long terme.

  - En mettant en œuvre ce système de distribution équitable, Xenify vise à créer des conditions égales pour tous les utilisateurs, en empêchant toute concentration de jetons dans les mains de quelques utilisateurs précoces. Au contraire, le protocole met l'accent sur l'importance de l'implication et des contributions continues des utilisateurs, car elles se traduisent directement par des récompenses tangibles. Cette approche innovante fait de Xenify une plateforme qui valorise sa communauté et encourage activement sa participation à l'élaboration de l'écosystème.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Pourquoi la valeur du XNF va-t-elle augmenter ?
  - La valeur du XNF a le potentiel d'augmenter de manière significative en raison de la tokenomique innovante de Xenify, de l'écosystème florissant et de la demande croissante de récompenses natives. Grâce à l'agrégateur cross-chain de pointe de Xenify, les utilisateurs peuvent profiter d'un échange de jetons transparent et s'engager dans diverses activités de récompense, ce qui favorise l'adoption du protocole et, en fin de compte, la valeur du XNF.

  - En outre, la rareté des jetons XNF, provoquée par les événements de réduction de moitié, est susceptible d'augmenter la valeur du jeton, car de plus en plus d'utilisateurs choisissent Xenify comme plateforme préférée pour échanger des jetons. Les détenteurs de veXNF recevront ainsi davantage de récompenses natives, ce qui entraînera une augmentation de la demande de jetons XNF. Par conséquent, la valeur du jeton est prête à augmenter en raison de la demande, consolidant la position de Xenify en tant que projet prometteur au sein de l'écosystème XEN.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ À quoi sert le bouton de recyclage ?
- Le bouton de recyclage est une fonctionnalité conviviale qui donne la priorité aux besoins des détenteurs de veXNF. En cliquant simplement sur ce bouton, les utilisateurs peuvent facilement convertir leurs récompenses de chaîne natives accumulées en XNF via les enchères quotidiennes. Cette fonctionnalité apporte plusieurs avantages. Premièrement, il vous permet de participer au cycle de gravure sans encourir les frais de gravure obligatoires associés au processus de gravure par défaut. Cela signifie que vous pouvez profiter des avantages de l’acquisition de XNF tout au long du cycle de gravure tout en économisant sur les frais supplémentaires.

- De plus, en choisissant de recycler vos récompenses, vous contribuez activement à la croissance et à la pérennité de l'écosystème Xenify. Après avoir déduit les frais de brûlage des récompenses recyclées, le protocole alloue 90% des récompenses restantes pour créer des liquidités appartenant au protocole via les mécanismes d'achat et de gravure de XNF, favorisant ainsi la rareté et un marché plus efficace pour le jeton. Les 10% restants sont versés à l'équipe, pour soutenir les dépenses opérationnelles courantes, telles que le développement de la plateforme, les campagnes marketing et les activités d'engagement communautaire.

- En recyclant vos récompenses, vous améliorez non seulement vos propres avantages, mais vous jouez également un rôle essentiel dans le succès continu de la plateforme Xenify. En conséquence, les recycleurs pourront bénéficier d'une distribution exclusive supplémentaire de jetons natifs générés à partir des frais de réclamation de la plateforme lorsqu'ils choisiront de recycler au cours de la première heure d'un cycle. Cela signifie qu'en participant activement au processus de recyclage, vous avez la possibilité d'obtenir des récompenses supplémentaires, tout en augmentant vos avoirs globaux en XNF.

- En conclusion, la fonction du bouton de recyclage offre non seulement de la commodité mais présente également de nombreux avantages pour les détenteurs de veXNF. En économisant sur les frais, en contribuant à la croissance de l'écosystème et en accédant à des récompenses exclusives, les recycleurs peuvent maximiser leurs avantages tout en soutenant le succès continu de la plateforme Xenify.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Comment puis-je générer des récompenses avec Xenify ?
  - Xenify offre aux utilisateurs la possibilité de gagner des récompenses telles que ETH, BNB et MATIC sur une base quotidienne en verrouillant les jetons XNF. Ces récompenses sont distribuées parmi les détenteurs de veXNF en fonction de leur solde de veXNF et de la puissance associée à leur veXNF. Ce modèle d'incitation encourage non seulement la participation active, mais joue également un rôle essentiel dans la promotion de la croissance à long terme et de la durabilité du protocole.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Si je verrouille les XNF maintenant, quand pourrai-je les déverrouiller ?
  - Lorsque vous choisissez de verrouiller vos XNF, vous avez la possibilité de sélectionner un cycle de verrouillage qui correspond à vos préférences, allant d'un minimum d'une semaine à un maximum d'un an. Il est important de noter qu'une fois que vous avez commencé le cycle de verrouillage, vos jetons XNF seront verrouillés et vous ne pourrez pas les déverrouiller tant que le cycle ne sera pas terminé. Une fois le cycle de verrouillage choisi terminé, vous serez libre de déverrouiller vos jetons XNF et d'en récupérer la pleine propriété et le contrôle. En participant au verrouillage, vous contribuez à la santé globale de notre écosystème et, en retour, vous avez la possibilité de gagner des récompenses natives au quotidien !

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Si je verrouille mon XNF maintenant, quand recevrai-je des récompenses ?
  - Lorsque vous verrouillez votre XNF, vous recevez en échange un jeton unique ERC-721 non fongible (NFT) appelé veXNF. Ce jeton veXNF représente votre XNF verrouillé dans le protocole et, plus important encore, indique votre capacité de gain - influençant votre part des récompenses natives. Plus longtemps vous verrouillez votre XNF, plus votre capacité de gain en veXNF est élevée. Cependant, il est important de noter que cette capacité de gain diminue avec le temps, même si vous optez pour la période de blocage maximale d'un an.
  
  - Ce mécanisme de désintégration incite les utilisateurs à verrouiller pour des durées plus longues afin de maintenir une force de gain plus élevée plus longtemps. Tout au long de chaque cycle, les récompenses générées par les frais de gravure, les frais de swap et les frais natifs s'accumulent dans un pool de récompenses, et le protocole distribue l'intégralité du pool de récompenses des jetons de chaîne natifs entre les détenteurs de veXNF à la fin du cycle en fonction de leurs jetons XNF verrouillés et c'est la capacité de gain qui y est associée, garantissant une répartition juste et transparente.
...
- Oui, il y a plusieurs façons de participer à Xenify, notamment
  ...
  - Effectuer des brûlages directs de vXEN ou d'YSL pour acquérir des XNF.
  - Verrouiller les jetons XNF pour gagner des jetons natifs de la chaîne tels que ETH, BNB et MATIC.
  - Contribuer à la croissance du protocole par le biais d'initiatives communautaires.
 
![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Qu'advient-il des récompenses s'il n'y a pas de détenteurs de veXNF ?
- S'il n'y a pas de détenteurs de veXNF à la fin d'un cycle en raison de l'expiration de tous les verrous, la conception du protocole redirige les 25% des récompenses natives, initialement destinées aux détenteurs de veXNF, pour augmenter la liquidité appartenant au protocole. Par conséquent, l'intégralité de l'allocation contribue à la liquidité du protocole en utilisant les mécanismes d'achat et de combustion de XNF pour ce cycle.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Que se passe-t-il s'il n'y a aucun participant aux enchères quotidiennes ?
- Dans le cas peu probable où un cycle se déroulerait sans aucun échange sur Xenify et sans aucun utilisateur participant à l'enchère de gravure ou à l'enchère native, la distribution quotidienne du cycle XNF n'aura pas lieu. Les jetons XNF qui devaient être distribués au cours de ce cycle ne seront pas émis. Par conséquent, l’offre globale de XNF sera réduite du nombre destiné à être distribué au cours de ce cycle. Par exemple, si l'allocation quotidienne pour un cycle a été fixée à 20 000 XNF et qu'aucun échange n'a été effectué au cours de ce cycle ni aucun jeton contribué au brûlage et aux enchères natives, alors ces 20 000 XNF ne seront ni émis ni distribués. Au lieu de cela, l’offre totale de XNF sera réduite de 20 000 XNF à la fin du cycle.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Que se passe-t-il si seulement une ou deux des enchères quotidiennes comptent des participants ?
- La distribution XNF s'effectue via trois enchères quotidiennes. Chaque jour, 50% des jetons XNF sont alloués aux participants aux enchères. De plus, 50% de l'offre quotidienne de XNF est réservée aux récompenses veXNF, ces récompenses étant verrouillées pendant un an avant d'être distribuées aux participants aux enchères natives (45%) et aux enchères d'échange (5%). Dans le cas où une ou deux des enchères quotidiennes manquent de participants, le protocole adapte la distribution quotidienne de XNF pour garantir l'équité.
  
- Le protocole est conçu pour redistribuer dynamiquement les récompenses selon différents scénarios : sans brûler les participants aux enchères, 90% des XNF quotidiens vont aux participants aux enchères natifs sous forme de récompenses veXNF, et les 10% restants sont destinés à échanger les participants aux enchères sous forme de récompenses veXNF ; en l'absence de participants aux enchères de swap, 50% sont distribués comme d'habitude pour brûler les participants aux enchères et les participants aux enchères natifs reçoivent les 50% restants sous forme de récompenses veXNF. S'il n'y a pas de participants natifs aux enchères, 50% sont distribués comme d'habitude pour brûler les participants aux enchères, et les 50% restants pour échanger les participants aux enchères sous forme de récompenses veXNF. En l’absence de participants aux enchères natifs et brûlés, 100% vont à l’échange de participants aux enchères en tant que veXNF ; aucun participant aux enchères natifs et swap signifie 100% pour les participants aux enchères burn, et aucun participant aux enchères swap et burn n'attribue 100% aux participants aux enchères natifs en tant que récompenses veXNF.
  
- En bref, quelle que soit l'enchère à laquelle participent les participants, elle obtient des récompenses. Cette approche adaptative garantit que l'activité est systématiquement récompensée, même dans des scénarios de faible participation aux enchères, favorisant ainsi une distribution équilibrée et efficace.
...
- YSL a été conçu pour être un jeton hyper-déflationniste, alliant rareté quantifiable et utilité grâce aux enchères quotidiennes de Xenify. Avec une offre totale fixe et un mécanisme de combustion intégré, YSL a le potentiel de prendre de la valeur au fil du temps à mesure que l'offre en circulation diminue. YSL y parvient grâce à son intégration avec les enchères de gravure quotidiennes de Xenify, qui attribuent les XNF nouvellement créés aux utilisateurs qui choisissent de graver leurs jetons YSL. Cette source quotidienne constante de demande de gravure de jetons YSL génère une pression déflationniste perpétuelle, contrairement à d'autres jetons déflationnistes dépendant uniquement de l'activité commerciale. En bref, la tokenomique déflationniste de YSL offre une opportunité intrigante – avec une rareté codifiée, une utilité et des moteurs prévisibles de croissance de la valeur.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ XNF

  - XNF est le jeton d'équité natif de Xenify, un protocole d'agrégation inter-chaînes de pointe dans le domaine de la finance décentralisée (DeFi). Les utilisateurs peuvent gagner des jetons XNF en participant activement aux activités de la plateforme, par exemple en brûlant des jetons vXEN ou YSL et en échangeant des jetons sur les chaînes prises en charge.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ vXEN

- vXEN est la contrepartie virtuelle du jeton XEN, conçu pour rationaliser le processus de combustion des jetons et faciliter les interactions entre les chaînes au sein de l'écosystème Xenify. Il permet aux détenteurs de participer aux enchères de Xenify sur différentes chaînes et assure une migration transparente des jetons, renforçant ainsi l'engagement de Xenify en faveur de l'interopérabilité et de la fonctionnalité inter-chaînes.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ veXNF

  - Le veXNF est un jeton acquis, incarné par un jeton non fongible (NFT) selon la norme ERC-721, qui représente la position verrouillée d'un utilisateur dans le XNF. La part d'un utilisateur dans les récompenses natives n'est pas seulement dictée par la quantité de veXNF qu'il possède. Elle est également influencée par son "pouvoir" ou sa position dans le protocole. Cette position est déterminée par une combinaison de ses avoirs en veXNF et de la durée de sa période de verrouillage.

![Grey V4](https://user-images.githubusercontent.com/60996729/235287926-6b18081e-ca41-48c7-8dfc-29cc32c598f1.png)

## ◽️ Xenify

  - Xenify est un protocole de finance décentralisée (DeFi) conçu pour révolutionner l'expérience d'échange de jetons. Il offre un agrégateur inter-chaînes de pointe, facilitant l'échange de jetons entre 54 chaînes différentes. Grâce à l'accès aux meilleurs itinéraires et aux frais les plus bas de 60 agrégateurs, Xenify permet aux utilisateurs d'échanger des jetons de manière transparente entre les chaînes prises en charge. Xenify met l'accent sur l'équité, la simplicité, la transparence, l'autonomisation des utilisateurs et l'interopérabilité, dans le but de créer un écosystème DeFi plus connecté et plus convivial.
...
## ◽️ Brûlures directes
  ...
  - Lorsqu'un jeton est brûlé, il est généralement envoyé à une adresse inactive et retiré de la circulation, ce qui a pour effet de réduire l'offre totale de la quantité brûlée. Sur Xenify, les brûlages directs se produisent lorsque les utilisateurs brûlent délibérément des jetons (vXEN ou YSL) pour promouvoir la croissance du protocole.  En récompense de leur engagement envers le protocole, les utilisateurs reçoivent des jetons XNF en échange de leurs jetons vXEN ou YSL brûlés.
...
## ♦️ XEN Crypto (Oct 8, 2022) - Protocole de chaîne croisée
...
## ♦️ DBXen (16 février 2023) - Génération de rendement inter-chaînes
...
## ♦️ XEN
 ...
 - [Optimisme](https://optimistic.etherscan.io/address/0xeB585163DEbB1E637c6D617de3bEF99347cd75c8)
