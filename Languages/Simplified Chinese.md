...
- 在 ETH 拍卖中，参与者将获得每日 XNF 供应量的 45% 作为 veXNF 奖励，这些奖励在可领取之前被锁定一年。这些奖励一旦领取，就会增加参与者未来 ETH 收入的盈利能力。掉期拍卖的参与者将获得剩余 5% 的 XNF 供应量作为 veXNF 奖励，并受到相同的一年可领取锁定，增强了他们领取后的盈利能力。
...
- XNF 的最大供应量为 2260 万个代币。通过每日四次拍卖进行分配。每天，一定比例的 XNF 代币会分配给拍卖参与者：25% 分配给 YSL 销毁拍卖，另外 25% 分配给 vXEN 销毁拍卖参与者。此外，每日 XNF 供应量的 50% 保留用于 veXNF 奖励，这些奖励在分配给 ETH 拍卖（45%）和掉期拍卖（5%）的参与者之前被锁定一年。
...
XNF 代币的分配以一天为一个周期，从 20,000 个 XNF 代币的奖励池开始。每天的分配有四种方式：25% 分配给燃烧 vXEN 的用户，25% 分配给燃烧 YSL 的用户，45% 分配给原生代币贡献者，剩余的 5% 分配给平台的交换费贡献者。这种每日分配也将扩展到所有其他未来的部署链。通过实施减半模式，每天的铸币量会逐渐减少，最终在第 2461 个月完全分配完总共 2260 万个 XNF 代币。
...
Xenify 采用战略方法每天分配 XNF 代币，重点奖励其运营的所有 EVM 链生态系统中的四个关键参与者群体。这些群体是通过每日铸造代币总量的预定百分比来识别的：25% 授予燃烧 vXEN 代币的用户，另外 25% 授予燃烧 YSL 代币的用户，45% 的较大份额授予本机代币贡献者，最后的 5%那些参与代币交换的人。

例如，每日铸造量为 20,000 个 XNF 代币，考虑到可变的百分比指定，默认情况下分配不会平均分配。因此，vXEN 代币刻录者和 YSL 代币刻录者各获得 5,000 个 XNF 代币，代表各自 25% 的份额。原生代币贡献者被分配 9,000 个 XNF 代币，相当于分配的 45%，而交换参与者则被授予 1,000 个 XNF 代币，占剩余的 5%。这种系统化的分配流程在所有 EVM 链上都是统一的，确保对不同的用户活动提供公平和比例的奖励。
