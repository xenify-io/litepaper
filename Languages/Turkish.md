...
- Protokolümüz kapsamında, günlük açık artırmalardan toplanan ETH'nin %50'si ve her günlük döngüden geri dönüştürülen ETH'nin %90'ı, Uniswap V3'teki WETH-XNF çifti aracılığıyla XNF'yi doğrudan piyasadan satın almak için kullanılıyor. Daha sonra, edinilen XNF'nin %100'ü değişmez bir süreç aracılığıyla derhal ve geri dönülemez bir şekilde yakılır. Bu uygulama, geri satın alma ve yakma prosedürlerinin bütünlüğünü sağlar, üçüncü tarafların katılımı ihtiyacını ortadan kaldırır ve böylece karşı tarafın öne çıkmasıyla ilişkili riskleri azaltır.
...
- Ve ödüller gelmeye devam ediyor! veXNF'e sahip olmak, her döngü sırasında oluşan yakma ve takas ücretlerine bağlı olarak size ETH, BNB ve MATIC gibi ek günlük ödüller kazanma hakkı verir. Xenify yalnızca takas sürecini basitleştirmekle kalmıyor; onu dönüştürüyor. Size yalnızca en yüksek verimliliği ve pazar lideri oranları sunmakla kalmıyoruz, aynı zamanda gerçekten ödüllendirici bir takas deneyimi de sunuyoruz.
...
Yakılan her parti için sağladığınız tokenler (vXEN veya YSL) kalıcı olarak dolaşımdan kaldırılır, Yakma Ücretinizin %40'ı XNF için protokole ait likidite oluşturmak için kullanılır, %40'ı veXNF sahipleri arasında yerel ödüller olarak dağıtılır, %10'u Otomatik günlük XNF geri alımı ve yakma işlemi gerçekleştirmek için kullanılır ve kalan %10'luk kısım Xenify ekibine gönderilir. yakma mekanizması, XEN ve YSL tokenlarının dolaşımdaki arzını azaltmanın ötesine geçiyor; Ekosistemimizin büyümesini desteklerken ve aktif katılımcıları ödüllendirirken YSL ve daha geniş XEN topluluklarını tüm zincirlerde birleştiren stratejik bir yaklaşımı bünyesinde barındırıyor.
...
Bu geri dönüşüm mekaniği, ekosisteme ve geri dönüşümcülere çok sayıda fayda sağlar. Kullanıcılara yalnızca zorunlu yakma ücretini sağlamadan günlük yakma açık artırmasına katılma olanağı sağlamakla kalmıyor, aynı zamanda geri dönüştürülen ödüllerin bir kısmının XNF protokolüne ait likidite oluşturmak için kullanılmasıyla XNF için satın alma baskısını aktif olarak artırıyor. Bu stratejik yaklaşım, kullanıcıların kazanç potansiyellerini protokolün büyümesiyle uyumlu bir şekilde en üst düzeye çıkarmalarına olanak tanır.
...
Yakma ücretinin %40'ı bir kenara ayrılarak döngü sonunda uygun veXNF sahiplerine dağıtılacak, %10'u ekibe gönderilecek ve geri kalan %50'si XNF protokolüne ait likidite oluşturmak için kullanılacak. Ardından, ödüllerinizden kalan 0,5025 BNB bölünür: %90'ı (0,45225 ETH) XNF protokolüne ait likidite oluşturmak için kullanılır ve %10'u (0,05025 ETH) Xenify ekibine gönderilir. Döngünün sonunda 100 toplu yakma katkınız karşılığında XNF alırsınız. Ancak hepsi bu kadar değil, döngünün ilk saatinde ödülleri geri dönüştürdüğünüz için %25'lik talep ücretinden toplanan ETH'den de pay alacaksınız!
...
- Üstelik ödüllerinizi geri dönüştürmeyi seçerek Xenify ekosisteminin büyümesine ve sürdürülebilirliğine aktif olarak katkıda bulunmuş olursunuz. Geri dönüştürülen ödüllerden Yakma Ücreti düşüldükten sonra protokol, kalan ödüllerinizin %90'ını XNF likidite oluşturmak için kullanır ve token için daha sağlam ve verimli bir pazar sağlar. Ek olarak, kalan %10'luk kısım ekibe gönderilerek platform geliştirme, pazarlama kampanyaları ve topluluk katılımı faaliyetleri gibi devam eden operasyonel harcamalar destekleniyor.
...
- Sonuç olarak, tamamlanan döngü için takas ücretlerinden, yerel ücretlerden ve yakma ücretlerinden üretilen tüm yerel tokenlerin %80'i, orijinal %40 tahsisi yerine XNF likiditesini sağlamak için kullanılacaktır. Yerel ödüllerin kalan %10'u her zamanki gibi Xenify ekibine tahsis edilecek ve son %10, protokolün otomatik XNF geri satın alma ve yakma işlevi için ayrılacak.
