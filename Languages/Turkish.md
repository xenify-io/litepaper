...
Bu 1.500.000 XNF tokeni, başlangıçta lansman gününde kilitli tokenlar olarak dağıtılacak ve 730 günlük bir süre içinde kademeli olarak kilitleri açılacak. Örneğin, airdroptan 7300 kilitli XNF tokenı alırsanız, cüzdanınızda her gün yaklaşık 10 XNF tokeninin kilidinin açılmasını bekleyebilirsiniz. Bu tokenler, lansmana kadar olan günlük takas katkılarına göre takas katılımcıları arasında paylaştırılacağından, etkinlik sırasında ne kadar çok takas yaparsanız XNF Airdrop'tan payınız o kadar büyük olacaktır! Artık bu XNF tokenlarından kazanma isteğinizi anlıyoruz ve portföyünüzün gelişmesine tanık oluyoruz. Ancak küçük bir sorun var: Airdropped XNF tokenleri cüzdanınızda açılana kadar stake edilemez. Dolayısıyla, protokolün yerel ödüllerinden pay almayı hedefliyorsanız, ilk yakma müzayedesine de katılmanızı önemle tavsiye ederiz. Bu, ilk dağıtımdan yerel ödüllerin bir kısmını kazanma biletiniz!
