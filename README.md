...
### 🔶 Direct Burns
  -  Half of the total supply (10,500,000 XNF tokens) is designated for users participating in the burning of DXN or FENIX tokens. This distribution method employs one-day cycles and an initial reward pool of 10,000 XNF tokens. The reward pool diminishes by roughly 0.2% per cycle, with XNF token distribution dependent on users' burn participation.
