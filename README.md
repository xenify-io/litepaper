...
### 🔶 Swap Volume
  - The other half of the total supply (10,500,000 XNF tokens) is allocated based on the swap volume generated by users on Xenify. This also adheres to a daily cycle, with XNF proportionate to users' contributions to the swap volume. This strategy ensures that users are rewarded for both their involvement in the direct burning process and their active participation in generating swap volume within the Xenify ecosystem.
