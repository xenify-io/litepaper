...
The Phoenix NFT has been designed to be a game-changer in the world of NFTs. With its innovative rental mechanism, this unique NFT actively supports the YSL.IO ecosystem and allows users to generate rental income, whilst renters enjoy the advantage of bypassing the protocol’s Sigma Exit Rate. When a Phoenix Ape NFT is rented through the Xenify marketplace, a portion of the user's rental income is collected as tax. Combined with a share of royalty taxes from OpenSea, these earnings are then distributed among all Phoenix Ape NFT holders as USDC rewards on the BNB Chain at the end of each 8-hour epoch. These USDC rewards will be available for holders to claim at the end of each 8-hour epoch.
