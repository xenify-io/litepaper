...
- [Burnamentals](https://github.com/xenify-io/litepaper#%EF%B8%8F-burnamentals)
...
For those short on time, this section provides an overview of the core "Burnamentals" that drive Xenify's vision and set it apart from other platforms. You'll learn how Xenify generates unmatched liquidity provisioning for XNF holders, rewards users for swapping and burning tokens, and incorporates a daily buyback and burn mechanism to bolster value while reducing the circulating supply of XNF.
