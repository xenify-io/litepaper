...
100% of the native chain tokens collected from the protocol fee will be sent to the XEN recycling contract, where they will be redeployed to support the ecosystem. 50% of the fee creates XNF liquidity, 25% creates XEN native token liquidity, and the remaining 25% is used by the team to promote and enhance the Xenify platform and its associated tokens, ensuring increased awareness and adoption.
