...
Welcome to Xenify! Our groundbreaking protocol synergistically blends DBXen’s innovative tokenomics and ChainZap’s powerful functionality into one powerful package, setting the stage for a seismic shift in the DeFi landscape. With a maximum total supply of only 21,500,000 XNF tokens, Xenify empowers users to earn XNF by burning XEN or USDy tokens while simultaneously functioning as a first-layer burner for the XEN token. Our overarching mission? To revolutionise the DeFi space with a seamless, ultra-efficient cross-chain swapping experience that lavishes users with Native Chain Rewards and a token with a finite supply.
...
Furthermore, Xenify's innovative design has facilitated seamless integration with the YSL.IO protocol and it’s state-of-the-art AlphaVaults and MetaVaults. This integration directs a remarkable 100% of yields acquired from interest and rehypothecation of vault assets straight to XNF stakers. This strategy guarantees a consistent stream of Native Chain Rewards for stakers, even if there are no swaps or burns performed on Xenify. As a result, long-term user engagement is encouraged, and rewards are boosted for those who are deeply committed to the protocol.
...
But there's more! Xenify is not just a platform for cross-chain swaps; it's a meticulously crafted ecosystem with unique tokenomics, utilising swap and burn fee mechanisms to benefit all participants. The optional 0.5% swap fee, which users can choose to pay when making a swap, not only fuels Xenify's competitive edge but also rewards Xenify users and XNF stakers. It's a true win-win!

Here's how it works: When users opt to pay the swap fee, they not only facilitate their transactions but also secure a position in the daily XNF reward cycle. From the swap fee, 50% is allocated to support the team in funding future audits, development, and marketing efforts, while the remaining 50% is distributed as native chain rewards to staked XNF holders on supported chains. That's right – XNF stakers can benefit from every swap on supported chains!
...
In addition to the swap and burn fees, XNF stakers will also benefit from Xenify's strategic integration of the YSL.IO protocol. This secondary layer of Xenify's staking framework rewards XNF stakers from the yield derived from the assets deposited in YSL.IO's state-of-the-art AlphaVaults and MetaVaults, ensuring that even if there are no swaps or burns performed on the platform, XNF stakers still receive Native Chain Rewards. This innovative approach to staking and rewards, paired with Xenify's unique tokenomics model, guarantees that the platform will remain ahead of the curve, attract a growing user base, and contribute to the project's overall success.
...
### ♦️ Stake XNF to earn native tokens 
  ...
  - But that's not all! XNF stakers will also benefit from Xenify's strategic integration of YSL.IO's state-of-the-art AlphaVaults and MetaVaults. This secondary layer of Xenify's framework rewards XNF stakers from the yield derived from the vaults' assets, ensuring that even if there are no swaps or burns performed on the platform, XNF stakers still receive Native Chain Rewards.

  - Here's how it works: every day, the protocol distributes 100% of burn fees (originating from direct burns of XEN or USDy), 100% of YSL.IO AlphaVault and MetaVault yields, and 50% of the platform's swap fees (generated on supported chains) to XNF stakers. These rewards are allocated in the form of native chain tokens—a highly liquid asset—signalling a potentially lucrative return for users staking XNF.
...
Phoenix Ape NFT holders enjoy an exclusive and amplified burn effect when they choose to burn XEN or USDy on Xenify. This unique advantage empowers NFT holders to secure a larger share of the daily distribution of XNF, while also benefiting from significant discounts on their burn fees. By bridging both communities, this exceptional benefit fosters unity and fuels growth for both protocols.

When Phoenix Ape NFT holders opt to burn XEN or USDy on Xenify, they are rewarded with a burn bonus that doubles their batch count (NB). This multiplier is capped at 1,000 batches per NFT ID. Once a user exhausts all 1,000 batches allocated to their Phoenix Ape NFT, that particular NFT will no longer provide an amplified burn, even across other chains.

But fret not! By owning or renting at least 4 of these coveted NFTs, your wallet will be granted a daily bonus of 4,000 batches. This means you can enjoy maximum savings of up to 50% off, equivalent to 10,000 batches, by burning a mere 6,000 batches. And the best part? The bonus multiplier resets every day, giving you the opportunity to benefit from this amplified burn effect on a daily basis!

Now, let's delve into how the burn process works for different scenarios:

 ** 1. If you hold one to three Phoenix Ape NFTs:** When you decide to burn a certain amount of batches, the protocol first checks if any of the NFTs you hold have a bonus balance. If you do have a bonus balance and choose to burn an amount lower than your current bonus for a specific NFT ID, the protocol will match the burn amount to effectively double the batch count. For instance, if you have a current bonus of 1,000 batches on your NFT and decide to burn the equivalent of 10 batches, this will count as 20 batches during the burn process, with 10 bonus batches utilised. Consequently, 10 batches from the 1,000 bonus allocated to your NFT ID will be deducted, leaving you with 990 bonus batches. On the other hand, if you decide to burn an amount greater than your current bonus, the protocol will use your NFT's entire bonus balance. For example, if your current bonus is 1,000 batches and you choose to burn the equivalent of 5,000 batches, this will count as 6,000 batches during the burn process, with the protocol utilising the entire 1,000 batches from your NFT's bonus. As a result, 1,000 batches from the bonus allocated to the NFT ID will be removed, leaving zero bonus batches remaining for use.

**  2. If you hold a minimum of 4 Phoenix Ape NFTs:** For holders of 4 Phoenix Ape NFTs, burning batches becomes even more rewarding. When you decide to burn a batch amount lower than your current bonus, the protocol will double your batch count by using an equivalent amount. Let's say you hold 4 NFTs and have a daily bonus of 4,000 batches. If you choose to burn the equivalent of 1 batch, it will count as 2 batches during the burn process, with 1 batch deducted from your daily NFTs bonus. This leaves you with 3,999 bonus batches for the day. However, if you opt to burn a batch amount greater than your current daily bonus, the protocol will utilise your entire bonus balance. For instance, let's say a you hold 4 NFTs have a current daily bonus of 4,000 batches. If you opt to burn the equivalent of 6,000 batches; it will be counted as 10,000 batches during the burn process - with the protocol utilising your entire 4,000 daily batch bonus. As a result, you will now have zero bonus batches remaining to use on that particular day. And don’t fret, once the next day commences, your bonus batch count will be reset back to 4,000.
