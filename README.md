...
When Phoenix Ape NFT holders opt to burn XEN or USDy on Xenify, they are rewarded with a burn bonus that doubles their batch count (NB). This multiplier is capped at 100 batches per NFT ID. Once a user exhausts all 100 batches allocated to their Phoenix Ape NFT, that particular NFT will no longer provide an amplified burn, even across other chains.

But fret not! By owning or renting at least 4 of these coveted NFTs, your wallet will be granted a daily bonus of 1,000 batches. This means you can enjoy maximum savings of up to 50% off, equivalent to 10,000 batches, by burning only 9,000 batches. And the best part? The bonus multiplier resets every day, giving you the opportunity to benefit from this amplified burn effect on a daily basis!

Now, let's delve into how the burn process works for different scenarios:

  **1. If you hold one to three Phoenix Ape NFTs:** 

  When you decide to burn a certain amount of batches, the protocol first checks if any of the NFTs you hold have a bonus balance. If you do have a bonus balance and choose to burn an amount lower than your current bonus for a specific NFT ID, the protocol will match the burn amount to effectively double the batch count. For instance, if you have a current bonus of 100 batches on your NFT and decide to burn the equivalent of 10 batches, this will count as 20 batches during the burn process, with 10 bonus batches utilised. Consequently, 10 batches from the 100 bonus allocated to your NFT ID will be deducted, leaving you with 99 bonus batches. On the other hand, if you decide to burn an amount greater than your current bonus, the protocol will use your NFT's entire bonus balance. For example, if your current bonus is 100 batches and you choose to burn the equivalent of 5,000 batches, this will count as 5,100 batches during the burn process, with the protocol utilising the entire 100 batches from your NFT's bonus. As a result, 100 batches from the bonus allocated to the NFT ID will be removed, leaving zero bonus batches remaining for use.

  **2. If you hold a minimum of 4 Phoenix Ape NFTs:** 

  For holders of 4 Phoenix Ape NFTs, burning batches becomes even more rewarding. When you decide to burn a batch amount lower than your current bonus, the protocol will double your batch count by using an equivalent amount. Let's say you hold 4 NFTs and have a daily bonus of 1,000 batches. If you choose to burn the equivalent of 1 batch, it will count as 2 batches during the burn process, with 1 batch deducted from your daily NFTs bonus. This leaves you with 999 bonus batches for the day. However, if you opt to burn a batch amount greater than your current daily bonus, the protocol will utilise your entire bonus balance. For instance, let's say a you hold 4 NFTs have a current daily bonus of 1,000 batches. If you opt to burn the equivalent of 9,000 batches; it will be counted as 10,000 batches during the burn process - with the protocol utilising your entire 1,000 daily batch bonus. As a result, you will now have zero bonus batches remaining to use on that particular day. And don’t fret, once the next day commences, your bonus batch count will be reset back to 1,000.
