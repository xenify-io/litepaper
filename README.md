<p align="center" dir="auto">
  <picture>
    <source media="(prefers-color-scheme: light)" srcset="https://user-images.githubusercontent.com/60996729/234733618-32a764b5-da06-4428-ae0c-a05693392b60.png" class="source-light">
    ...
    <img alt="Xenify" src="https://user-images.githubusercontent.com/60996729/234733607-bfe9950e-23e5-4f9a-889c-386221b06cc2.png" style="visibility:visible;max-width:100%;">
  </picture>
</p>
...
Xenify's mission is to revolutionize the DeFi landscape by tackling the challenges and limitations that hinder the widespread adoption of decentralized finance, with a primary focus on cross-chain aggregation and seamless user experience.

As the premier cross-chain swap aggregator, we aim to deliver a frictionless, secure, and equitable platform for token swapping and staking across multiple blockchain networks. Our commitment is to continuously refine and optimize Xenify's features, catering to the dynamic needs of the DeFi community while attracting an ever-growing user base.

By championing cross-chain capabilities and fostering interoperability, we endeavor to support a diverse array of blockchain networks, fueling greater synergy within the DeFi ecosystem. Leveraging advanced liquidity aggregation and cross-chain functionality, we strive to streamline interactions between various chains, unlocking the full potential of the DeFi landscape.

Xenify is deeply committed to cultivating community-driven growth and collaboration within the XEN ecosystem. We passionately empower our users to actively participate in decision-making, governance, and the platform's ongoing development. Our mission is to nurture a vibrant, global community of users and enthusiasts, united by a shared vision of transforming the world of decentralized finance.
...
### 🔶 Direct Burns
  -  The other half of the total supply (10,500,000 XNF tokens) is allocated based on the swap volume generated by users on Xenify. This also adheres to a daily cycle, starting with an initial XNF pool of 5,000 XNF tokens. The XNF pool for swap volume decreases by approximately 0.2% per cycle, ensuring that XNF equity is proportionate to users' contributions to the swap volume. This strategy ensures that users are rewarded for both burning tokens and actively participating in the Xenify ecosystem.

### 🔶 Swap Volume
  - The other half of the total supply (10,500,000 XNF tokens) is allocated based on the swap volume generated by users on Xenify. This also adheres to a daily cycle, starting with an initial reward pool of 5,000 XNF tokens. The XNF pool for swap volume decreases by approximately 0.2% per cycle, ensuring that rewards are proportionate to users' contributions to the swap volume. This strategy ensures that users are rewarded for both burning tokens and actively participating in the Xenify ecosystem.
...
### ♦️ Staking 
  ...
  - Explore Xenify's innovative staking model that empowers users to stake XNF tokens and earn a portion of protocol fees originating from direct burns of DXN or FENIX. Delight in the advantage of receiving rewards in the form of ETH, a highly sought-after and liquid asset, ensuring a remarkable return on your investment.
  ...
  - Dive headfirst into Xenify's enticing ecosystem, masterfully designed to benefit every participant and cultivate a flourishing, community-driven environment. Seize the opportunities presented by this trailblazing platform and witness firsthand the potential of a decentralized and interconnected financial future.
